(function t(e, i, o) {
    ...
    1: [function (t, e, i) {
        ...
        var o, n = (o = t("../../../../../external/cannon/cannon")) && o.__esModule ? o : {default: o};
        ...
        var s = new n.default.Vec3, a = new n.default.Vec3, l = cc.Vec3, h = function () {
            function t() {
            ...
            return o.__preload = function (t) {
                ...
                key: "isAwake", get: function () {
                    return this._sharedBody.body.isAwake()
                }
            }, {
                key: "isSleepy", get: function () {
                    return this._sharedBody.body.isSleepy()
                }
            }, {
                key: "isSleeping", get: function () {
                    return this._sharedBody.body.isSleeping()
                }
            }, {
                key: "allowSleep", set: function (t) {
                    var e = this._sharedBody.body;
                    e.isSleeping() && e.wakeUp(), e.allowSleep = t
                }
            }, {
                key: "mass", set: function (t) {
                    var e = this._sharedBody.body;
                    e.mass = t, 0 == e.mass ? e.type = n.default.Body.STATIC : e.type = this._rigidBody.isKinematic ? n.default.Body.KINEMATIC : n.default.Body.DYNAMIC, e.updateMassProperties(), e.isSleeping() && e.wakeUp()
                }
            }, {
                key: "isKinematic", set: function (t) {
                    var e = this._sharedBody.body;
                    0 == e.mass ? e.type = n.default.Body.STATIC : e.type = t ? n.default.Body.KINEMATIC : n.default.Body.DYNAMIC
                }
            }, {
                key: "fixedRotation", set: function (t) {
                    var e = this._sharedBody.body;
                    e.isSleeping() && e.wakeUp(), e.fixedRotation = t, e.updateMassProperties()
                }
            }, {
                key: "linearDamping", set: function (t) {
                    this._sharedBody.body.linearDamping = t
                }
            }, {
                key: "angularDamping", set: function (t) {
                    this._sharedBody.body.angularDamping = t
                }
            }, {
                key: "useGravity", set: function (t) {
                    var e = this._sharedBody.body;
                    e.isSleeping() && e.wakeUp(), e.useGravity = t
                }
            }, {
                key: "linearFactor", set: function (t) {
                    var e = this._sharedBody.body;
                    e.isSleeping() && e.wakeUp(), l.copy(e.linearFactor, t)
                }
            }, {
                key: "angularFactor", set: function (t) {
                    var e = this._sharedBody.body;
                    e.isSleeping() && e.wakeUp(), l.copy(e.angularFactor, t)
                }
            }, {
                key: "rigidBody", get: function () {
                    return this._rigidBody
                }
            }, {
                key: "sharedBody", get: function () {
    ...
    2: [function (t, e, i) {
        ...
        var h = cc.Node._LocalDirtyFlag.PHYSICS_SCALE, c = cc.Quat, p = cc.Vec3, u = cc.js.array.fastRemoveAt,
            d = new p, y = new c, f = [],
            v = {type: "collision-enter", selfCollider: null, otherCollider: null, contacts: []}, m = function () {
                function t(t, e) {
                ...
                return o._updateGroup = function () {
                    ...
                    e >= 0 && (u(this.shapes, e), this.body.removeShape(t.shape), t.setIndex(-1))
                }, o.syncSceneToPhysics = function (t) {
                    void 0 === t && (t = !1);
                    var e = this.node, i = (0, s.worldDirty)(e);
                    if (t || i) {
                        if (this.body.aabbNeedsUpdate = !0, e.getWorldPosition(d), e.getWorldRotation(y), p.copy(this.body.position, d), c.copy(this.body.quaternion, y), e._localMatDirty & h) {
                    ...
                    this.body.type == r.ERigidBodyType.STATIC || this.body.isSleeping() || (p.copy(d, this.body.position), c.copy(y, this.body.quaternion), this.node.setWorldPosition(d), this.node.setWorldRotation(y))
                }, o.destroy = function () {
                    this.body.removeEventListener("cc-collide", this.onCollidedListener), this.node.off(cc.Node.EventType.GROUP_CHANGED, this._updateGroup, this), t.sharedBodiesMap.delete(this.node._id), delete n.default.World.idToBodyMap[this.body.id], this.node = null, this.wrappedWorld = null, this.body = null, this.shapes = null, this.onCollidedListener = null
                    ...
                    if (e) {
                        ...
                        for (o = 0; o < t.contacts.length; o++) {
                            ...
                            if (f.length > 0) {
                                var r = f.pop();
                                p.copy(r.contactA, n.ri), p.copy(r.contactB, n.rj), p.copy(r.normal, n.ni), v.contacts.push(r)
                            } else {
                                var l = {
                        ...
                        for (o = 0; o < this.shapes.length; o++) {
                            var h = this.shapes[o];
                            v.type = a.deprecatedEventMap[v.type], h.collider.emit(v.type, v), v.type = t.event, h.collider.emit(v.type, v)
                        }
                    }
                }, e = t, (i = [{
                    key: "enabled", set: function (t) {
                        if (t) {
                            if (this.index < 0) {
                                this.index = this.wrappedWorld.bodies.length, this.wrappedWorld.addSharedBody(this);
                                var e = this.node;
                                this.body.aabbNeedsUpdate = !0, e.getWorldPosition(d), e.getWorldRotation(y);
                                var i = this.body.position;
                                i.x = parseFloat(d.x.toFixed(3)), i.y = parseFloat(d.y.toFixed(3)), i.z = parseFloat(d.z.toFixed(3));
                                var o = this.body.quaternion;
                                if (o.x = parseFloat(y.x.toFixed(12)), o.y = parseFloat(y.y.toFixed(12)), o.z = parseFloat(y.z.toFixed(12)), o.w = parseFloat(y.w.toFixed(12)), e._localMatDirty & h) {
    ...
    3: [function (t, e, i) {
        "use strict";
        i.__esModule = !0, i.commitShapeUpdates = function (t) {
            t.aabbNeedsUpdate = !0, t.updateMassProperties(), t.updateBoundingRadius()
        }, i.deprecatedEventMap = void 0, i.fillRaycastResult = function (t, e) {
            t._assign(n.copy(new n, e.hitPointWorld), e.distance, (0, o.getWrap)(e.shape).collider)
        }, i.groupIndexToBitMask = r, i.toCannonRaycastOptions = function (t, e) {
    ...
    4: [function (t, e, i) {
        ...
        var o, n = (o = t("../../../../../external/cannon/cannon")) && o.__esModule ? o : {default: o},
            r = t("./cannon-util"), s = t("./shapes/cannon-shape"), a = t("./cannon-shared-body"),
            l = t("../framework/util");
        ...
        var c = cc.Vec3, p = cc.js.array.fastRemoveAt, u = function () {
            function t() {
            ...
            return o.onPostStep = function () {
                ...
                if (t.useFixedDigit) for (var e = t.fixDigits.position, i = t.fixDigits.rotation, o = this._world.bodies, r = 0; r < o.length; r++) {
                    ...
                    if (s.type != n.default.Body.STATIC && !s.isSleeping()) {
                        var a = s.position;
                        a.x = parseFloat(a.x.toFixed(e)), a.y = parseFloat(a.y.toFixed(e)), a.z = parseFloat(a.z.toFixed(e));
                        var l = s.quaternion;
                        l.x = parseFloat(l.x.toFixed(i)), l.y = parseFloat(l.y.toFixed(i)), l.z = parseFloat(l.z.toFixed(i)), l.w = parseFloat(l.w.toFixed(i));
                        var h = s.velocity;
                        h.x = parseFloat(h.x.toFixed(e)), h.y = parseFloat(h.y.toFixed(e)), h.z = parseFloat(h.z.toFixed(e));
                        var c = s.angularVelocity;
                        c.x = parseFloat(c.x.toFixed(e)), c.y = parseFloat(c.y.toFixed(e)), c.z = parseFloat(c.z.toFixed(e))
                    }
                }
                ...
                f(t, e.maxDistance), (0, r.toCannonRaycastOptions)(v, e);
                var o = this._world.raycastClosest(d, y, v, this._raycastResult);
                return o && (0, r.fillRaycastResult)(i, this._raycastResult), o
                ...
                return f(t, e.maxDistance), (0, r.toCannonRaycastOptions)(v, e), this._world.raycastAll(d, y, v, function (t) {
                    var e = i.add();
                    (0, r.fillRaycastResult)(e, t), o.push(e)
                })
                ...
                e >= 0 && (p(this.bodies, e), this._world.remove(t.body))
            }, e = t, (i = [{
                key: "world", get: function () {
                    return this._world
                }
            }, {
                key: "defaultMaterial", set: function (t) {
                ...
                key: "gravity", set: function (t) {
                    c.copy(this._world.gravity, t)
                }
            }]) && h(e.prototype, i), t
        }();
        i.CannonWorld = u;
        var d = new n.default.Vec3, y = new n.default.Vec3;
    ...
    5: [function (t) {
        "use strict";
        var e = t("../framework/physics-selector"), i = t("./cannon-rigid-body"), o = t("./cannon-world"),
            n = t("./shapes/cannon-box-shape"), r = t("./shapes/cannon-sphere-shape");
    ...
    6: [function (t, e, i) {
        ...
        var h = cc.Vec3, c = new h, p = function (t) {
            var e, i;

            function o(e) {
                var i;
                return (i = t.call(this) || this).halfExtent = new n.default.Vec3, h.multiplyScalar(i.halfExtent, e, .5), i._shape = new n.default.Box(i.halfExtent.clone()), i
            }

            i = t, (e = o).prototype = Object.create(i.prototype), e.prototype.constructor = e, l(e, i);
            ...
            return u.onLoad = function () {
                ...
                key: "size", set: function (t) {
                    this.collider.node.getWorldScale(c), c.x = Math.abs(c.x), c.y = Math.abs(c.y), c.z = Math.abs(c.z), h.multiplyScalar(this.halfExtent, t, .5), h.multiply(this.box.halfExtents, this.halfExtent, c), this.box.updateConvexPolyhedronRepresentation(), -1 != this._index && (0, r.commitShapeUpdates)(this._body)
                }
            }]) && a(s.prototype, p), o
        }(s.CannonShape);
        i.CannonBoxShape = p
    }, {"../../../../../../external/cannon/cannon": 24, "../cannon-util": 3, "./cannon-shape": 7}],
    7: [function (t, e, i) {
        "use strict";
        ...
        var l = {type: "trigger-enter", selfCollider: null, otherCollider: null}, h = cc.Vec3, c = new h,
            p = function () {
                function t() {
                    this._collider = void 0, this._shape = void 0, this._offset = new n.default.Vec3, this._orient = new n.default.Quaternion, this._index = -1, this._sharedBody = void 0, this.onTriggerListener = this.onTrigger.bind(this)
                }
                ...
                return o.__preload = function (t) {
                    ...
                    var e = this._offset;
                    h.copy(e, t), this._collider.node.getWorldScale(c), h.multiply(e, e, c)
                }, o.onTrigger = function (t) {
                    l.type = t.event;
                    var e = (0, r.getWrap)(t.selfShape), i = (0, r.getWrap)(t.otherShape);
                    e && (l.selfCollider = e.collider, l.otherCollider = i ? i.collider : null, l.type = s.deprecatedEventMap[l.type], this._collider.emit(l.type, l), l.type = t.event, this._collider.emit(l.type, l))
                }, e = t, (i = [{
                    key: "shape", get: function () {
                        return this._shape
                    }
                }, {
                    key: "collider", get: function () {
                        return this._collider
                    }
                }, {
                    key: "attachedRigidBody", get: function () {
    ...
    8: [function (t, e, i) {
        ...
        var h = new cc.Vec3, c = function (t) {
            var e, i;

            function o(e) {
                var i;
                return (i = t.call(this) || this)._radius = void 0, i._radius = e, i._shape = new n.default.Sphere(i._radius), i
            }
            ...
            return p.onLoad = function () {
                ...
                key: "sphereCollider", get: function () {
                    return this.collider
                }
            }, {
                key: "sphere", get: function () {
                    return this._shape
                }
            }, {
                key: "radius", get: function () {
                    ...
                    var e = h.maxAxis();
                    this.sphere.radius = t * Math.abs(e), this.sphere.updateBoundingSphereRadius(), -1 != this._index && (0, r.commitShapeUpdates)(this._body)
                }
            }]) && a(s.prototype, c), o
        }(s.CannonShape);
    ...
    9: [function (t) {
        ...
        var e, i = (e = t("../../../../../external/cannon/cannon")) && e.__esModule ? e : {default: e};
        window && (window.CANNON = i.default)
    }, {"../../../../../external/cannon/cannon": 24, "../cannon/instantiate": 5}],
    10: [function (t, e, i) {
        "use strict";
        i.__esModule = !0;
        var o = t("../framework");
    ...
    11: [function (t, e, i) {
        ...
        var y = cc._decorator, f = y.ccclass, v = y.property, m = cc.js.array.fastRemove, g = cc.math.equals,
            b = f("cc.PhysicsMaterial")((l = a = function (t) {
                var e, i;

                function o() {
                    var e;
                    return h(e = t.call(this) || this, "_friction", r, p(e)), h(e, "_restitution", s, p(e)), cc.EventTarget.call(p(e)), o.allMaterials.push(p(e)), "" == e._uuid && (e._uuid = "pm_" + o._idCounter++), e
                }

                i = t, (e = o).prototype = Object.create(i.prototype), e.prototype.constructor = e, u(e, i);
                var n, a, l = o.prototype;
                return l.clone = function () {
                    var t = new o;
                    return t._friction = this._friction, t._restitution = this._restitution, t
                }, l.destroy = function () {
                    return !!t.prototype.destroy.call(this) && (m(o.allMaterials, this), !0)
                }, n = o, (a = [{
                    key: "friction", get: function () {
                        return this._friction
                    }, set: function (t) {
                        g(this._friction, t) || (this._friction = t, this.emit("physics_material_update"))
                    }
                }, {
                    key: "restitution", get: function () {
                        return this._restitution
                    }, set: function (t) {
                        g(this._restitution, t) || (this._restitution = t, this.emit("physics_material_update"))
                    }
                }]) && c(n.prototype, a), o
            }(cc.Asset), a.allMaterials = [], a._idCounter = 0, r = d((n = l).prototype, "_friction", [v], {
                configurable: !0,
                enumerable: !0,
                writable: !0,
            ...
            }), d(n.prototype, "friction", [v], Object.getOwnPropertyDescriptor(n.prototype, "friction"), n.prototype), d(n.prototype, "restitution", [v], Object.getOwnPropertyDescriptor(n.prototype, "restitution"), n.prototype), o = n)) || o;
    ...
    12: [function (t, e, i) {
        ...
        var m = cc._decorator, g = m.ccclass, b = m.executeInEditMode, w = m.executionOrder, x = m.menu, _ = m.property,
            B = cc.Vec3,
            S = (o = g("cc.BoxCollider3D"), n = w(98), r = x("i18n:MAIN_MENU.component.physics/Collider/Box 3D"), s = _({type: cc.Vec3}), o(a = n(a = r(a = b((v((l = function (t) {
                var e, i, o, n;

                function r() {
                    var e;
                    return u(e = t.call(this) || this, "_size", h, y(e)), e._shape = (0, c.createBoxShape)(e._size), e
                }

                return i = t, (e = r).prototype = Object.create(i.prototype), e.prototype.constructor = e, f(e, i), o = r, (n = [{
                    key: "size",
                    get: function () {
                        return this._size
                    },
                    set: function (t) {
                        B.copy(this._size, t), this.boxShape.size = this._size
                    }
                }, {
                    key: "boxShape", get: function () {
                        return this._shape
                    }
                }]) && d(o.prototype, n), r
            }(p.Collider3D)).prototype, "size", [s], Object.getOwnPropertyDescriptor(l.prototype, "size"), l.prototype), h = v(l.prototype, "_size", [_], {
                configurable: !0,
                enumerable: !0,
                writable: !0,
                initializer: function () {
        ...
        i.BoxCollider3D = S
    }, {"../../instance": 18, "./collider-component": 13}],
    13: [function (t, e, i) {
        "use strict";
        ...
        var b = cc._decorator, w = b.ccclass, x = b.property, _ = cc.Vec3, B = (o = w("cc.Collider3D"), n = x({
            type: d.PhysicsMaterial,
            displayName: "Material",
            displayOrder: -1
        }), r = x({displayOrder: 0}), s = x({
            type: cc.Vec3,
            displayOrder: 1
        }), a = x({type: d.PhysicsMaterial}), o((g((h = function (t) {
            var e, i;

            function o() {
                var e;
                return (e = t.call(this) || this)._shape = void 0, e._isSharedMaterial = !0, y(e, "_material", c, v(e)), y(e, "_isTrigger", p, v(e)), y(e, "_center", u, v(e)), cc.EventTarget.call(v(e)), e
            }

            i = t, (e = o).prototype = Object.create(i.prototype), e.prototype.constructor = e, m(e, i);
            ...
            return s.on = function () {
                ...
                key: "sharedMaterial", get: function () {
                ...
                key: "center", get: function () {
                    ...
                    _.copy(this._center, t), this._shape.center = this._center
                }
            }, {
                key: "attachedRigidbody", get: function () {
                ...
                key: "_assertOnload", get: function () {
                    var t = 0 == this._isOnLoadCalled;
                    return t && cc.error("Physics Error: Please make sure that the node has been added to the scene"), !t
                }
            }]) && f(n.prototype, r), o
        }(cc.Component)).prototype, "sharedMaterial", [n], Object.getOwnPropertyDescriptor(h.prototype, "sharedMaterial"), h.prototype), g(h.prototype, "isTrigger", [r], Object.getOwnPropertyDescriptor(h.prototype, "isTrigger"), h.prototype), g(h.prototype, "center", [s], Object.getOwnPropertyDescriptor(h.prototype, "center"), h.prototype), c = g(h.prototype, "_material", [a], {
            configurable: !0,
            enumerable: !0,
            writable: !0,
            initializer: function () {
        ...
        i.Collider3D = B, cc.js.mixin(B.prototype, cc.EventTarget.prototype)
    ...
    14: [function (t, e, i) {
        ...
        var d = cc._decorator, y = d.ccclass, f = d.executeInEditMode, v = d.executionOrder, m = d.menu, g = d.property,
            b = y("cc.SphereCollider3D")(o = v(98)(o = m("i18n:MAIN_MENU.component.physics/Collider/Sphere 3D")(o = f((u((n = function (t) {
                var e, i, o, n;

                function a() {
                    var e;
                    return l(e = t.call(this) || this, "_radius", r, c(e)), e._shape = (0, s.createSphereShape)(e._radius), e
                }

                return i = t, (e = a).prototype = Object.create(i.prototype), e.prototype.constructor = e, p(e, i), o = a, (n = [{
                    key: "radius",
                    get: function () {
                        return this._radius
                    },
                    ...
                    key: "sphereShape", get: function () {
                        return this._shape
                    }
                }]) && h(o.prototype, n), a
            }(a.Collider3D)).prototype, "radius", [g], Object.getOwnPropertyDescriptor(n.prototype, "radius"), n.prototype), r = u(n.prototype, "_radius", [g], {
                configurable: !0,
                enumerable: !0,
                writable: !0,
                initializer: function () {
    ...
    15: [function (t, e, i) {
        ...
        var B = cc._decorator, S = B.ccclass, E = B.executeInEditMode, M = B.executionOrder, C = B.menu, A = B.property,
            z = B.requireComponent, F = B.disallowMultiple, R = cc.Vec3,
            T = (o = S("cc.ConstantForce"), n = M(98), r = z(m.RigidBody3D), s = C("i18n:MAIN_MENU.component.physics/Constant Force 3D"), a = A({displayOrder: 0}), l = A({displayOrder: 1}), h = A({displayOrder: 2}), c = A({displayOrder: 3}), o(p = n(p = r(p = s(p = F(p = E((u = function (t) {
                var e, i;

                function o() {
                    for (var e, i = arguments.length, o = new Array(i), n = 0; n < i; n++) o[n] = arguments[n];
                    return (e = t.call.apply(t, [this].concat(o)) || this)._rigidbody = null, g(e, "_force", d, w(e)), g(e, "_localForce", y, w(e)), g(e, "_torque", f, w(e)), g(e, "_localTorque", v, w(e)), e._mask = 0, e
                }

                i = t, (e = o).prototype = Object.create(i.prototype), e.prototype.constructor = e, x(e, i);
                var n, r, s = o.prototype;
                return s.onLoad = function () {
                    this._rigidbody = this.node.getComponent(m.RigidBody3D), this._maskUpdate(this._force, 1), this._maskUpdate(this._localForce, 2), this._maskUpdate(this._torque, 4), this._maskUpdate(this._localTorque, 8)
                    ...
                    key: "force", get: function () {
                        ...
                        R.copy(this._force, t), this._maskUpdate(this._force, 1)
                    }
                }, {
                    key: "localForce", get: function () {
                        return this._localForce
                    }, set: function (t) {
                        R.copy(this._localForce, t), this._maskUpdate(this.localForce, 2)
                    }
                }, {
                    key: "torque", get: function () {
                        return this._torque
                    }, set: function (t) {
                        R.copy(this._torque, t), this._maskUpdate(this._torque, 4)
                    }
                }, {
                    key: "localTorque", get: function () {
                        return this._localTorque
                    }, set: function (t) {
                        R.copy(this._localTorque, t), this._maskUpdate(this._localTorque, 8)
                    }
                }]) && b(n.prototype, r), o
            }(cc.Component), d = _(u.prototype, "_force", [A], {
                configurable: !0,
                enumerable: !0,
                writable: !0,
                initializer: function () {
    ...
    16: [function (t, e, i) {
        ...
        var F = cc._decorator, R = F.ccclass, T = F.disallowMultiple, P = F.executeInEditMode, q = F.executionOrder,
            O = F.menu, I = F.property, V = cc.Vec3,
            j = (o = R("cc.RigidBody3D"), n = q(99), r = O("i18n:MAIN_MENU.component.physics/Rigid Body 3D"), s = I({displayOrder: 0}), a = I({displayOrder: 1}), l = I({displayOrder: 2}), h = I({displayOrder: 3}), c = I({displayOrder: 4}), p = I({displayOrder: 5}), u = I({displayOrder: 6}), d = I({displayOrder: 7}), o(y = n(y = r(y = P(y = T((z((f = function (t) {
                var e, i;

                function o() {
                    var e;
                    return (e = t.call(this) || this)._body = void 0, e._allowSleep = !0, E(e, "_mass", v, C(e)), E(e, "_linearDamping", m, C(e)), E(e, "_angularDamping", g, C(e)), E(e, "_fixedRotation", b, C(e)), E(e, "_isKinematic", w, C(e)), E(e, "_useGravity", x, C(e)), E(e, "_linearFactor", _, C(e)), E(e, "_angularFactor", B, C(e)), e._body = (0, S.createRigidBody)(), e
                }
            ...
            }(cc.Component)).prototype, "mass", [s], Object.getOwnPropertyDescriptor(f.prototype, "mass"), f.prototype), z(f.prototype, "linearDamping", [a], Object.getOwnPropertyDescriptor(f.prototype, "linearDamping"), f.prototype), z(f.prototype, "angularDamping", [l], Object.getOwnPropertyDescriptor(f.prototype, "angularDamping"), f.prototype), z(f.prototype, "isKinematic", [h], Object.getOwnPropertyDescriptor(f.prototype, "isKinematic"), f.prototype), z(f.prototype, "useGravity", [c], Object.getOwnPropertyDescriptor(f.prototype, "useGravity"), f.prototype), z(f.prototype, "fixedRotation", [p], Object.getOwnPropertyDescriptor(f.prototype, "fixedRotation"), f.prototype), z(f.prototype, "linearFactor", [u], Object.getOwnPropertyDescriptor(f.prototype, "linearFactor"), f.prototype), z(f.prototype, "angularFactor", [d], Object.getOwnPropertyDescriptor(f.prototype, "angularFactor"), f.prototype), v = z(f.prototype, "_mass", [I], {
                configurable: !0,
                enumerable: !0,
                writable: !0,
                initializer: function () {
    ...
    18: [function (t, e, i) {
        "use strict";
        i.__esModule = !0, i.createBoxShape = function (t) {
    ...
    19: [function (t, e, i) {
        "use strict";
        var o;
        i.__esModule = !0, i.ERigidBodyType = void 0, i.ERigidBodyType = o, function (t) {
    ...
    20: [function (t, e, i) {
        ...
        var o, n, r, s, a, l, h, c, p = t("./instance"), u = t("./assets/physics-material"),
        ...
        var m = cc._decorator, g = m.property, b = (0, m.ccclass)("cc.Physics3DManager")((r = v((n = function () {
            function t() {
                this.physicsWorld = void 0, this.raycastClosestResult = new d.PhysicsRayResult, this.raycastResults = [], y(this, "_enabled", r, this), y(this, "_allowSleep", s, this), y(this, "_gravity", a, this), y(this, "_maxSubStep", l, this), y(this, "_fixedTime", h, this), y(this, "_useFixedTime", c, this), this.useAccumulator = !1, this._accumulator = 0, this.useFixedDigit = !1, this.useInternalTime = !1, this.fixDigits = {
                    position: 5,
                    rotation: 12,
                    timeNow: 3
                }, this._deltaTime = 0, this._lastTime = 0, this._material = null, this.raycastOptions = {
                    groupIndex: -1,
                    queryTrigger: !0,
                    maxDistance: 1 / 0
            ...
            return o.update = function (t) {
                if (this._enabled) {
                    if (this.useInternalTime) {
                        ...
                        this._deltaTime = e > this._lastTime ? (e - this._lastTime) / 1e3 : 0, this._lastTime = e
                    } else this._deltaTime = t;
                    if (cc.director.emit(cc.Director.EVENT_BEFORE_PHYSICS), this._useFixedTime) this.physicsWorld.step(this._fixedTime); else if (this.useAccumulator) {
                        var i = 0;
                        for (this._accumulator += this._deltaTime; i < this._maxSubStep && this._accumulator > this._fixedTime;) this.physicsWorld.step(this._fixedTime), this._accumulator -= this._fixedTime, i++
                ...
                if (void 0 === e && (e = 0), void 0 === i && (i = 1 / 0), void 0 === o && (o = !0), this.raycastResultPool.reset(), this.raycastResults.length = 0, "string" == typeof e) {
                    ...
                    -1 == n && (n = 0), this.raycastOptions.groupIndex = n
                ...
                key: "maxSubStep", get: function () {
                    return this._maxSubStep
                }, set: function (t) {
                    this._maxSubStep = t
                }
            }, {
                key: "deltaTime", get: function () {
                    return this._fixedTime
                }, set: function (t) {
                    this._fixedTime = t
                }
            }, {
                key: "useFixedTime", get: function () {
                    return this._useFixedTime
                }, set: function (t) {
                    this._useFixedTime = t
                }
            }, {
                key: "gravity", get: function () {
                    return this._gravity
                }, set: function (t) {
                    this._gravity.set(t), this.physicsWorld.gravity = t
                }
            }, {
                key: "defaultMaterial", get: function () {
                    return this._material
                }
            }]) && f(e.prototype, i), t
    ...
    }, {"./assets/physics-material": 11, "./instance": 18, "./physics-ray-result": 21}],
    21: [function (t, e, i) {
        "use strict";
        ...
        var n = cc.Vec3, r = function () {
            ...
            return r._assign = function (t, e, i) {
                ...
                var e = new t;
                return n.copy(e._hitPoint, this._hitPoint), e._distance = this._distance, e._collidier = this._collidier, e
            }, e = t, (i = [{
                key: "hitPoint", get: function () {
    ...
    22: [function (t, e, i) {
        "use strict";
        var o, n, r, s;
        i.__esModule = !0, i.SphereShape = i.RigidBody = i.PhysicsWorld = i.BoxShape = void 0, i.instantiate = function (t, e, a, l) {
            i.BoxShape = o = t, i.SphereShape = n = e, i.RigidBody = r = a, i.PhysicsWorld = s = l
        }, i.BoxShape = o, i.SphereShape = n, i.RigidBody = r, i.PhysicsWorld = s
    }, {}],
    23: [function (t, e, i) {
        "use strict";
        i.__esModule = !0, i.clearNodeTransformDirtyFlag = function () {
            for (var t in w) {
                var e = w[t];
            ...
            var o = t.parent;
            o ? (x(o, !0), c.transformMat4(y, e, h.invert(b, o._worldMatrix)), p.multiply(g, p.conjugate(g, o.__wrot), i), t.setPosition(y), t.setRotation(g)) : (t.setPosition(e), t.setRotation(i))
        }, i.updateWorldTransform = x, i.worldDirty = function (t) {
            for (var e = t; e;) {
        ...
        var o = cc.Node._LocalDirtyFlag, n = o.PHYSICS_TRS, r = o.ALL_TRS, s = o.SKEW, a = cc.RenderFlow.FLAG_TRANSFORM,
            l = cc.Mat3, h = cc.Mat4, c = cc.Vec3, p = cc.Quat, u = cc.Trs, d = [], y = cc.v3(), f = cc.quat(),
            v = new l, m = v.m, g = cc.quat(), b = cc.mat4(), w = {};
    ...
    24: [function (t, e, i) {
        (function (o) {
            "use strict";
            !function (t) {
                if ("object" == typeof i && void 0 !== e) e.exports = t(); else if ("function" == typeof define && define.amd) define([], t); else {
                    var n;
                ...
                return function e(i, o, n) {
                    ...
                    1: [function (t, e) {
                        e.exports = {
                            ...
                            engines: {node: "*"},
                            repository: {type: "git", url: "https://github.com/cocos-creator/cannon.js.git"},
                            bugs: {url: "https://github.com/cocos-creator/cannon.js/issues"},
                            licenses: [{type: "MIT"}],
                            devDependencies: {
                                jshint: "latest",
                                "uglify-js": "latest",
                    ...
                    3: [function (t, e) {
                        ...
                        o.prototype.setFromPoints = function (t, e, i, o) {
                            ...
                            for (var l = 1; l < t.length; l++) {
                                var h = t[l];
                                a && (a.vmult(h, n), h = n), h.x > s.x && (s.x = h.x), h.x < r.x && (r.x = h.x), h.y > s.y && (s.y = h.y), h.y < r.y && (r.y = h.y), h.z > s.z && (s.z = h.z), h.z < r.z && (r.z = h.z)
                            }
                        ...
                        o.prototype.toLocalFrame = function (t, e) {
                            var i = r, o = i[0], n = i[1], s = i[2], a = i[3], l = i[4], h = i[5], c = i[6], p = i[7];
                            ...
                            var e = 1 / t._direction.x, i = 1 / t._direction.y, o = 1 / t._direction.z,
                                n = (this.lowerBound.x - t.from.x) * e, r = (this.upperBound.x - t.from.x) * e,
                                s = (this.lowerBound.y - t.from.y) * i, a = (this.upperBound.y - t.from.y) * i,
                                l = (this.lowerBound.z - t.from.z) * o, h = (this.upperBound.z - t.from.z) * o,
                                c = Math.max(Math.max(Math.min(n, r), Math.min(s, a)), Math.min(l, h)),
                                p = Math.min(Math.min(Math.max(n, r), Math.max(s, a)), Math.max(l, h));
                            return !(p < 0 || c > p)
                        }
                    }, {"../math/Vec3": 32, "../utils/Utils": 55}],
                    4: [function (t, e) {
                        function i() {
                            this.matrix = []
                        }
                    ...
                    5: [function (t, e) {
                        ...
                        var s = new o;
                        new o, new n, new o, r.prototype.doBoundingSphereBroadphase = function (t, e, i, o) {
                            var n = s;
                        ...
                        r.prototype.makePairsUnique = function (t, e) {
                            for (var i = a, o = l, n = h, r = t.length, s = 0; s !== r; s++) o[s] = t[s], n[s] = e[s];
                            for (t.length = 0, e.length = 0, s = 0; s !== r; s++) {
                                var c = o[s].id, p = n[s].id;
                                i[u = c < p ? c + "," + p : p + "," + c] = s, i.keys.push(u)
                            }
                            for (s = 0; s !== i.keys.length; s++) {
                                var u = i.keys.pop(), d = i[u];
                                t.push(o[d]), e.push(n[d]), delete i[u]
                            }
                    ...
                    6: [function (t, e) {
                        ...
                        function r(t, e, n, r, s) {
                            i.apply(this), this.nx = n || 10, this.ny = r || 10, this.nz = s || 10, this.aabbMin = t || new o(100, 100, 100), this.aabbMax = e || new o(-100, -100, -100);
                            ...
                            for (l = Math.min, a = Math.max, q = 0; q !== o; q++) {
                                ...
                                switch (V.type) {
                                    ...
                                    case F:
                                        ...
                                        var W = V.worldNormal, D = g + .5 * S - it.position.x,
                                            U = b + .5 * E - it.position.y, G = w + .5 * M - it.position.z, H = s;
                                        H.set(D, U, G);
                                        for (var K = 0, Q = 0; K !== h; K++, Q += u, H.y = U, H.x += S) for (var X = 0, Y = 0; X !== c; X++, Y += d, H.z = G, H.y += E) for (var Z = 0, J = 0; Z !== p; Z++, J += y, H.z += M) if (H.dot(W) < C) {
                                            var $ = Q + Y + J;
                                            R[$][T[$]++] = it
                                        }
                                        break;
                                    default:
                                        it.aabbNeedsUpdate && it.computeAABB(), I(it.aabb.lowerBound.x, it.aabb.lowerBound.y, it.aabb.lowerBound.z, it.aabb.upperBound.x, it.aabb.upperBound.y, it.aabb.upperBound.z, it)
                                }
                            }
                            for (q = 0; q !== P; q++) {
                                var tt = T[q];
                    ...
                    }, {"../math/Vec3": 32, "../shapes/Shape": 45, "./Broadphase": 5}],
                    7: [function (t, e) {
                        e.exports = n;
                        ...
                        n.prototype = new i, n.prototype.constructor = n, n.prototype.collisionPairs = function (t, e, i) {
                            ...
                            for (o = 0; o !== l; o++) for (n = 0; n !== o; n++) r = a[o], s = a[n], this.needBroadphaseCollision(r, s) && this.intersectionTest(r, s, e, i)
                    ...
                    10: [function (t, e) {
                        e.exports = l;
                        var i = t("../math/Vec3"), o = t("../math/Quaternion"), n = t("../math/Transform"),
                            r = (t("../shapes/ConvexPolyhedron"), t("../shapes/Box"), t("../collision/RaycastResult")),
                            s = t("../shapes/Shape"), a = t("../collision/AABB");
                        ...
                        l.prototype.intersectWorld = function (t, e) {
                            return this.mode = e.mode || l.ANY, this.result = e.result || new r, this.skipBackfaces = !!e.skipBackfaces, this.checkCollisionResponse = !!e.checkCollisionResponse, this.collisionFilterMask = void 0 !== e.collisionFilterMask ? e.collisionFilterMask : -1, this.collisionFilterGroup = void 0 !== e.collisionFilterGroup ? e.collisionFilterGroup : -1, e.from && this.from.copy(e.from), e.to && this.to.copy(e.to), this.callback = e.callback || function () {
                            }, this.hasHit = !1, this.result.reset(), this._updateDirection(), this.getAABB(h), c.length = 0, t.broadphase.aabbQuery(t, h, c), this.intersectBodies(c), this.hasHit
                        };
                        var p = new i, u = new i;

                        function d(t, e, i, o) {
                            o.vsub(e, I), i.vsub(e, p), t.vsub(e, u);
                        ...
                        new i, new r, l.prototype.intersectBox = function (t, e, i, o, n) {
                            ...
                            s.vsub(o, c);
                            var p = c.dot(h);
                            if (a.vsub(o, c), !(p * c.dot(h) > 0 || s.distanceTo(a) < p)) {
                                var u = h.dot(l);
                        ...
                        var w = {faceList: [0]}, x = new i, _ = new l, B = [];
                        l.prototype.intersectHeightfield = function (t, e, i, o, r) {
                            t.data, t.elementSize;
                            var s = _;
                            s.from.copy(this.from), s.to.copy(this.to), n.pointToLocalFrame(i, e, s.from, s.from), n.pointToLocalFrame(i, e, s.to, s.to), s._updateDirection();
                            var l, h, c, p, u = B;
                            l = h = 0, c = p = t.data.length - 1;
                            var d = new a;
                            s.getAABB(d), t.getIndexOfPosition(d.lowerBound.x, d.lowerBound.y, u, !0), l = Math.max(l, u[0]), h = Math.max(h, u[1]), t.getIndexOfPosition(d.upperBound.x, d.upperBound.y, u, !0), c = Math.min(c, u[0] + 1), p = Math.min(p, u[1] + 1);
                            for (var y = l; y < c; y++) for (var f = h; f < p; f++) {
                                if (this.result._shouldStop) return;
                                if (t.getAabbAtIndex(y, f, d), d.overlapsRay(s)) {
                                    if (t.getConvexTrianglePillar(y, f, !1), n.pointToWorldFrame(i, e, t.pillarOffset, x), this.intersectConvex(t.pillarConvex, e, x, o, r, w), this.result._shouldStop) return;
                                    t.getConvexTrianglePillar(y, f, !0), n.pointToWorldFrame(i, e, t.pillarOffset, x), this.intersectConvex(t.pillarConvex, e, x, o, r, w)
                                }
                            }
                        }, l.prototype[s.types.HEIGHTFIELD] = l.prototype.intersectHeightfield;
                        var S = new i, E = new i;
                        l.prototype.intersectSphere = function (t, e, i, o, n) {
                            var r = this.from, s = this.to, a = t.radius,
                                ...
                                p = Math.pow(h, 2) - 4 * l * c, u = S, d = E;
                            if (!(p < 0)) if (0 === p) r.lerp(s, p, u), u.vsub(i, d), d.normalize(), this.reportIntersection(d, u, n, o, -1); else {
                                var y = (-h - Math.sqrt(p)) / (2 * l), f = (-h + Math.sqrt(p)) / (2 * l);
                                if (y >= 0 && y <= 1 && (r.lerp(s, y, u), u.vsub(i, d), d.normalize(), this.reportIntersection(d, u, n, o, -1)), this.result._shouldStop) return;
                                f >= 0 && f <= 1 && (r.lerp(s, f, u), u.vsub(i, d), d.normalize(), this.reportIntersection(d, u, n, o, -1))
                            }
                        ...
                        l.prototype.intersectConvex = function (t, e, i, o, n, r) {
                            for (var s = M, a = C, l = r && r.faceList || null, h = t.faces, c = t.vertices, p = t.faceNormals, u = this._direction, y = this.from, f = this.to, w = y.distanceTo(f), x = l ? l.length : h.length, _ = this.result, B = 0; !_._shouldStop && B < x; B++) {
                                var S = l ? l[B] : B, E = h[S], A = p[S], z = e, F = i;
                                a.copy(c[E[0]]), z.vmult(a, a), a.vadd(F, a), a.vsub(y, a), z.vmult(A, s);
                                var R = u.dot(s);
                                if (!(Math.abs(R) < this.precision)) {
                                    var T = s.dot(a) / R;
                                    if (!(T < 0)) {
                                        u.mult(T, v), v.vadd(y, v), m.copy(c[E[0]]), z.vmult(m, m), F.vadd(m, m);
                                        for (var P = 1; !_._shouldStop && P < E.length - 1; P++) {
                                            g.copy(c[E[P]]), b.copy(c[E[P + 1]]), z.vmult(g, g), z.vmult(b, b), F.vadd(g, g), F.vadd(b, b);
                        ...
                        l.prototype.intersectTrimesh = function (t, e, i, o, r, s) {
                            var a = A, l = q, h = O, c = C, p = z, u = F, y = R, f = P, w = T,
                                x = (s && s.faceList, t.indices), _ = (t.vertices, t.faceNormals, this.from),
                                B = this.to, S = this._direction;
                            h.position.copy(i), h.quaternion.copy(e), n.vectorToLocalFrame(i, e, S, p), n.pointToLocalFrame(i, e, _, u), n.pointToLocalFrame(i, e, B, y), y.x *= t.scale.x, y.y *= t.scale.y, y.z *= t.scale.z, u.x *= t.scale.x, u.y *= t.scale.y, u.z *= t.scale.z, y.vsub(u, p), p.normalize();
                            var E = u.distanceSquared(y);
                            t.tree.rayQuery(this, h, l);
                            for (var M = 0, I = l.length; !this.result._shouldStop && M !== I; M++) {
                                var V = l[M];
                                t.getNormal(V, a), t.getVertex(x[3 * V], m), m.vsub(u, c);
                                var j = p.dot(a), k = a.dot(c) / j;
                                if (!(k < 0)) {
                                    p.scale(k, v), v.vadd(u, v), t.getVertex(x[3 * V + 1], g), t.getVertex(x[3 * V + 2], b);
                                    var N = v.distanceSquared(u);
                                    !d(v, g, m, b) && !d(v, m, g, b) || N > E || (n.vectorToWorldFrame(e, a, w), n.pointToWorldFrame(i, e, v, f), this.reportIntersection(w, f, r, o, V))
                                }
                            }
                            l.length = 0
                            ...
                            if (!(this.skipBackfaces && t.dot(this._direction) > 0)) switch (h.hitFaceIndex = void 0 !== n ? n : -1, this.mode) {
                                case l.ALL:
                                    this.hasHit = !0, h.set(r, s, t, e, i, o, a), h.hasHit = !0, this.callback(h);
                                    break;
                                case l.CLOSEST:
                                    (a < h.distance || !h.hasHit) && (this.hasHit = !0, h.hasHit = !0, h.set(r, s, t, e, i, o, a));
                                    break;
                                case l.ANY:
                        ...
                        function j(t, e, i) {
                            i.vsub(t, I);
                            var o = I.dot(e);
                            return e.mult(o, V), V.vadd(t, V), i.distanceTo(V)
                        }
                    }, {
                        "../collision/AABB": 3,
                        "../collision/RaycastResult": 11,
                    ...
                    }, {"../collision/Broadphase": 5, "../shapes/Shape": 45}],
                    13: [function (t, e) {
                        e.exports = s, t("./Constraint");
                        var i = t("./PointToPointConstraint"), o = t("../equations/ConeEquation"),
                            n = t("../equations/RotationalEquation"),
                            r = (t("../equations/ContactEquation"), t("../math/Vec3"));

                        function s(t, e, s) {
                            var a = void 0 !== (s = s || {}).maxForce ? s.maxForce : 1e6,
                                l = s.pivotA ? s.pivotA.clone() : new r, h = s.pivotB ? s.pivotB.clone() : new r;
                            this.axisA = s.axisA ? s.axisA.clone() : new r, this.axisB = s.axisB ? s.axisB.clone() : new r, i.call(this, t, l, e, h, a), this.collideConnected = !!s.collideConnected, this.angle = void 0 !== s.angle ? s.angle : 0;
                            var c = this.coneEquation = new o(t, e, s), p = this.twistEquation = new n(t, e, s);
                            this.twistAngle = void 0 !== s.twistAngle ? s.twistAngle : 0, c.maxForce = 0, c.minForce = -a, p.maxForce = 0, p.minForce = -a, this.equations.push(c, p)
                        }
                        ...
                        s.prototype = new i, s.constructor = s, new r, new r, s.prototype.update = function () {
                            ...
                            i.prototype.update.call(this), t.vectorToWorldFrame(this.axisA, o.axisA), e.vectorToWorldFrame(this.axisB, o.axisB), this.axisA.tangents(n.axisA, n.axisA), t.vectorToWorldFrame(n.axisA, n.axisA), this.axisB.tangents(n.axisB, n.axisB), e.vectorToWorldFrame(n.axisB, n.axisB), o.angle = this.angle, n.maxAngle = this.twistAngle
                        }
                    }, {
                    ...
                    14: [function (t, e) {
                        ...
                        function o(t, e, n) {
                            n = i.defaults(n, {
                                collideConnected: !0,
                                wakeUpBodies: !0
                            }), this.equations = [], this.bodyA = t, this.bodyB = e, this.id = o.idCounter++, this.collideConnected = n.collideConnected, n.wakeUpBodies && (t && t.wakeUp(), e && e.wakeUp())
                        }
                    ...
                    15: [function (t, e) {
                        ...
                        function n(t, e, n, r) {
                            i.call(this, t, e), void 0 === n && (n = t.position.distanceTo(e.position)), void 0 === r && (r = 1e6), this.distance = n;
                        ...
                        n.prototype = new i, n.prototype.update = function () {
                            var t = this.bodyA, e = this.bodyB, i = this.distanceEquation, o = .5 * this.distance,
                                n = i.ni;
                    ...
                    16: [function (t, e) {
                        e.exports = s, t("./Constraint");
                        var i = t("./PointToPointConstraint"), o = t("../equations/RotationalEquation"),
                        ...
                        function s(t, e, s) {
                            var a = void 0 !== (s = s || {}).maxForce ? s.maxForce : 1e6,
                                l = s.pivotA ? s.pivotA.clone() : new r, h = s.pivotB ? s.pivotB.clone() : new r;
                            i.call(this, t, l, e, h, a), (this.axisA = s.axisA ? s.axisA.clone() : new r(1, 0, 0)).normalize(), (this.axisB = s.axisB ? s.axisB.clone() : new r(1, 0, 0)).normalize();
                            var c = this.rotationalEquation1 = new o(t, e, s),
                                p = this.rotationalEquation2 = new o(t, e, s), u = this.motorEquation = new n(t, e, a);
                        ...
                        s.prototype.update = function () {
                            var t = this.bodyA, e = this.bodyB, o = this.motorEquation, n = this.rotationalEquation1,
                                r = this.rotationalEquation2, s = a, h = l, c = this.axisA, p = this.axisB;
                            i.prototype.update.call(this), t.quaternion.vmult(c, s), e.quaternion.vmult(p, h), s.tangents(n.axisA, r.axisA), n.axisB.copy(h), r.axisB.copy(h), this.motorEquation.enabled && (t.quaternion.vmult(this.axisA, o.axisA), e.quaternion.vmult(this.axisB, o.axisB))
                        }
                    }, {
                        "../equations/ContactEquation": 20,
                        "../equations/RotationalEquation": 23,
                    ...
                    17: [function (t, e) {
                        e.exports = r, t("./Constraint");
                        var i = t("./PointToPointConstraint"), o = t("../equations/RotationalEquation"),
                            n = (t("../equations/RotationalMotorEquation"), t("../equations/ContactEquation"), t("../math/Vec3"));

                        function r(t, e, r) {
                            var s = void 0 !== (r = r || {}).maxForce ? r.maxForce : 1e6, a = new n, l = new n,
                                h = new n;
                        ...
                        r.prototype = new i, r.constructor = r, new n, new n, r.prototype.update = function () {
                            var t = this.bodyA, e = this.bodyB, o = (this.motorEquation, this.rotationalEquation1),
                                n = this.rotationalEquation2, r = this.rotationalEquation3;
                            i.prototype.update.call(this), t.vectorToWorldFrame(this.xA, o.axisA), e.vectorToWorldFrame(this.yB, o.axisB), t.vectorToWorldFrame(this.yA, n.axisA), e.vectorToWorldFrame(this.zB, n.axisB), t.vectorToWorldFrame(this.zA, r.axisA), e.vectorToWorldFrame(this.xB, r.axisB)
                        }
                    }, {
                        "../equations/ContactEquation": 20,
                        "../equations/RotationalEquation": 23,
                    ...
                    18: [function (t, e) {
                        ...
                        function r(t, e, r, s, a) {
                            i.call(this, t, r), a = void 0 !== a ? a : 1e6, this.pivotA = e ? e.clone() : new n, this.pivotB = s ? s.clone() : new n;
                            var l = this.equationX = new o(t, r), h = this.equationY = new o(t, r),
                        ...
                        r.prototype = new i, r.prototype.update = function () {
                            var t = this.bodyA, e = this.bodyB, i = this.equationX, o = this.equationY,
                                n = this.equationZ;
                    ...
                    }, {"../equations/ContactEquation": 20, "../math/Vec3": 32, "./Constraint": 14}],
                    19: [function (t, e) {
                        e.exports = r;
                        ...
                        function r(t, e, n) {
                            ...
                            o.call(this, t, e, -r, r), this.axisA = n.axisA ? n.axisA.clone() : new i(1, 0, 0), this.axisB = n.axisB ? n.axisB.clone() : new i(0, 1, 0), this.angle = void 0 !== n.angle ? n.angle : 0
                        }

                        r.prototype = new o, r.prototype.constructor = r;
                        var s = new i, a = new i;
                        r.prototype.computeB = function (t) {
                            var e = this.a, i = this.b, o = this.axisA, r = this.axisB, l = s, h = a,
                                c = this.jacobianElementA, p = this.jacobianElementB;
                            return o.cross(r, l), r.cross(o, h), c.rotational.copy(h), p.rotational.copy(l), -(n.cos(this.angle) - o.dot(r)) * e - this.computeGW() * i - t * this.computeGiMf()
                        }
                    }, {"../math/CMath": 27, "../math/Mat3": 29, "../math/Vec3": 32, "./Equation": 21}],
                    20: [function (t, e) {
                        e.exports = n;
                        ...
                        t("../math/Mat3"), n.prototype = new i, n.prototype.constructor = n;
                        var r = new o, s = new o, a = new o;
                        n.prototype.computeB = function (t) {
                            var e = this.a, i = this.b, o = this.bi, n = this.bj, l = this.ri, h = this.rj, c = r,
                                p = s, u = o.velocity, d = o.angularVelocity, y = (o.force, o.torque, n.velocity),
                                f = n.angularVelocity, v = (n.force, n.torque, a), m = this.jacobianElementA,
                                g = this.jacobianElementB, b = this.ni;
                            l.cross(b, c), h.cross(b, p), b.negate(m.spatial), c.negate(m.rotational), g.spatial.copy(b), g.rotational.copy(p), v.copy(n.position), v.vadd(h, v), v.vsub(o.position, v), v.vsub(l, v);
                            var w = b.dot(v), x = this.restitution + 1;
                            return -w * e - (x * y.dot(b) - x * u.dot(b) + f.dot(p) - d.dot(c)) * i - t * this.computeGiMf()
                        };
                        var l = new o, h = new o, c = new o, p = new o, u = new o;
                        n.prototype.getImpactVelocityAlongNormal = function () {
                            var t = l, e = h, i = c, o = p, n = u;
                    ...
                    }, {"../math/Mat3": 29, "../math/Vec3": 32, "./Equation": 21}],
                    21: [function (t, e) {
                        e.exports = n;
                        ...
                        n.prototype.constructor = n, n.id = 0, n.prototype.setSpookParams = function (t, e, i) {
                            ...
                            var t = this.jacobianElementA, e = this.jacobianElementB, i = this.bi, o = this.bj,
                                n = i.position, r = o.position;
                            return t.spatial.dot(n) + e.spatial.dot(r)
                        }, new o, n.prototype.computeGW = function () {
                            var t = this.jacobianElementA, e = this.jacobianElementB, i = this.bi, o = this.bj,
                                n = i.velocity, r = o.velocity, s = i.angularVelocity, a = o.angularVelocity;
                            return t.multiplyVectors(n, s) + e.multiplyVectors(r, a)
                        }, n.prototype.computeGWlambda = function () {
                            var t = this.jacobianElementA, e = this.jacobianElementB, i = this.bi, o = this.bj,
                                n = i.vlambda, r = o.vlambda, s = i.wlambda, a = o.wlambda;
                            return t.multiplyVectors(n, s) + e.multiplyVectors(r, a)
                        };
                        var r = new o, s = new o, a = new o, l = new o;
                        n.prototype.computeGiMf = function () {
                            var t = this.jacobianElementA, e = this.jacobianElementB, i = this.bi, o = this.bj,
                                n = i.force, h = i.torque, c = o.force, p = o.torque, u = i.invMassSolve,
                                d = o.invMassSolve;
                            return n.scale(u, r), c.scale(d, s), i.invInertiaWorldSolve.vmult(h, a), o.invInertiaWorldSolve.vmult(p, l), t.multiplyVectors(r, a) + e.multiplyVectors(s, l)
                        };
                        var h = new o;
                        n.prototype.computeGiMGt = function () {
                            var t = this.jacobianElementA, e = this.jacobianElementB, i = this.bi, o = this.bj,
                                n = i.invMassSolve, r = o.invMassSolve, s = i.invInertiaWorldSolve,
                                a = o.invInertiaWorldSolve, l = n + r;
                            return s.vmult(t.rotational, h), l += h.dot(t.rotational), a.vmult(e.rotational, h), l + h.dot(e.rotational)
                        };
                        var c = new o;
                        new o, new o, new o, new o, new o, n.prototype.addToWlambda = function (t) {
                    ...
                    }, {"../math/JacobianElement": 28, "../math/Vec3": 32}],
                    22: [function (t, e) {
                        e.exports = n;
                        var i = t("./Equation"), o = t("../math/Vec3");
                        ...
                        n.prototype.computeB = function (t) {
                            ...
                            i.cross(l, n), o.cross(l, a);
                            var h = this.jacobianElementA, c = this.jacobianElementB;
                            return l.negate(h.spatial), n.negate(h.rotational), c.spatial.copy(l), c.rotational.copy(a), -this.computeGW() * e - t * this.computeGiMf()
                        }
                    }, {"../math/Mat3": 29, "../math/Vec3": 32, "./Equation": 21}],
                    23: [function (t, e) {
                        e.exports = r;
                        ...
                        function r(t, e, n) {
                            var r = void 0 !== (n = n || {}).maxForce ? n.maxForce : 1e6;
                            o.call(this, t, e, -r, r), this.axisA = n.axisA ? n.axisA.clone() : new i(1, 0, 0), this.axisB = n.axisB ? n.axisB.clone() : new i(0, 1, 0), this.maxAngle = Math.PI / 2
                        }
                        ...
                        r.prototype.computeB = function (t) {
                            var e = this.a, i = this.b, o = this.axisA, r = this.axisB, l = s, h = a,
                                c = this.jacobianElementA, p = this.jacobianElementB;
                            return o.cross(r, l), r.cross(o, h), c.rotational.copy(h), p.rotational.copy(l), -(n.cos(this.maxAngle) - o.dot(r)) * e - this.computeGW() * i - t * this.computeGiMf()
                        }
                    }, {"../math/CMath": 27, "../math/Mat3": 29, "../math/Vec3": 32, "./Equation": 21}],
                    24: [function (t, e) {
                        e.exports = n;
                        ...
                        n.prototype = new o, n.prototype.constructor = n, n.prototype.computeB = function (t) {
                            this.a;
                            var e = this.b, i = (this.bi, this.bj, this.axisA), o = this.axisB,
                                n = this.jacobianElementA, r = this.jacobianElementB;
                    ...
                    25: [function (t, e) {
                        ...
                        function o(t, e, n) {
                            ...
                            }), this.id = o.idCounter++, this.materials = [t, e], this.friction = n.friction, this.restitution = n.restitution, this.contactEquationStiffness = n.contactEquationStiffness, this.contactEquationRelaxation = n.contactEquationRelaxation, this.frictionEquationStiffness = n.frictionEquationStiffness, this.frictionEquationRelaxation = n.frictionEquationRelaxation
                        }
                    ...
                    27: [function (t, e) {
                        ...
                        var p = {sin: Math.sin, cos: Math.cos, atan2: Math.atan2};
                        p._sin = a, p._cos = l, p._sinArr = n, p._sin360 = s, p._sinNative = h, p._cosNative = c, p._radian2angle = o, p._calculateSinByDigit = r, p._digit = 1, Object.defineProperty(p, "digit", {
                            get: function () {
                                return this._digit
                            }, set: function (t) {
                                this._digit = t, 1 == this._mode && r(t)
                            }
                        }), p._mode = 0, Object.defineProperty(p, "mode", {
                            get: function () {
                                return this._mode
                            }, set: function (t) {
                    ...
                    29: [function (t, e) {
                        ...
                        o.prototype.identity = function () {
                            ...
                            return e.x = o[0] * n + o[1] * r + o[2] * s, e.y = o[3] * n + o[4] * r + o[5] * s, e.z = o[6] * n + o[7] * r + o[8] * s, e
                            ...
                            do {
                                e = 2;
                                do {
                                    if (s = i[3 + e + 6 * n], isNaN(s) || s === 1 / 0) throw"Could not reverse! A=[" + this.toString() + "]";
                                    t.e(n, e, s)
                                } while (e--)
                            } while (n--);
                            return t
                        }, o.prototype.setRotationFromQuaternion = function (t) {
                            var e = t.x, i = t.y, o = t.z, n = t.w, r = e + e, s = i + i, a = o + o, l = e * r,
                                h = e * s, c = e * a, p = i * s, u = i * a, d = o * a, y = n * r, f = n * s, v = n * a,
                                m = this.elements;
                            return m[0] = 1 - (p + d), m[1] = h - v, m[2] = c + f, m[3] = h + v, m[4] = 1 - (l + d), m[5] = u - y, m[6] = c - f, m[7] = u + y, m[8] = 1 - (l + p), this
                    ...
                    30: [function (t, e) {
                        ...
                        n.prototype.set = function (t, e, i, o) {
                            ...
                            var i = o.sin(.5 * e);
                            return this.x = t.x * i, this.y = t.y * i, this.z = t.z * i, this.w = o.cos(.5 * e), this
                        }, n.prototype.toAxisAngle = function (t) {
                            t = t || new i, this.normalize();
                            var e = 2 * Math.acos(this.w), o = Math.sqrt(1 - this.w * this.w);
                            return o < .001 ? (t.x = this.x, t.y = this.y, t.z = this.z) : (t.x = this.x / o, t.y = this.y / o, t.z = this.z / o), [t, e]
                        };
                        var r = new i, s = new i;
                        n.prototype.setFromVectors = function (t, e) {
                            ...
                            e = e || new i;
                            var o = t.x, n = t.y, r = t.z, s = this.x, a = this.y, l = this.z, h = this.w,
                                c = h * o + a * r - l * n, p = h * n + l * o - s * r, u = h * r + s * n - a * o,
                                d = -s * o - a * n - l * r;
                            return e.x = c * h + d * -s + p * -l - u * -a, e.y = p * h + d * -a + u * -s - c * -l, e.z = u * h + d * -l + c * -a - p * -s, e
                        }, n.prototype.copy = function (t) {
                            return this.x = t.x, this.y = t.y, this.z = t.z, this.w = t.w, this
                        }, n.prototype.toEuler = function (t, e) {
                            var i, n, r;
                            e = e || "YZX";
                            var s = this.x, a = this.y, l = this.z, h = this.w;
                            switch (e) {
                                case"YZX":
                                    var c = s * a + l * h;
                                    if (c > .499 && (i = 2 * o.atan2(s, h), n = Math.PI / 2, r = 0), c < -.499 && (i = -2 * o.atan2(s, h), n = -Math.PI / 2, r = 0), isNaN(i)) {
                                        var p = s * s, u = a * a, d = l * l;
                                        i = o.atan2(2 * a * h - 2 * s * l, 1 - 2 * u - 2 * d), n = Math.asin(2 * c), r = o.atan2(2 * s * h - 2 * a * l, 1 - 2 * p - 2 * d)
                                    }
                                    break;
                                default:
                            ...
                            n = n || "XYZ";
                            var r = o.cos(t / 2), s = o.cos(e / 2), a = o.cos(i / 2), l = o.sin(t / 2),
                                h = o.sin(e / 2), c = o.sin(i / 2);
                            return "XYZ" === n ? (this.x = l * s * a + r * h * c, this.y = r * h * a - l * s * c, this.z = r * s * c + l * h * a, this.w = r * s * a - l * h * c) : "YXZ" === n ? (this.x = l * s * a + r * h * c, this.y = r * h * a - l * s * c, this.z = r * s * c - l * h * a, this.w = r * s * a + l * h * c) : "ZXY" === n ? (this.x = l * s * a - r * h * c, this.y = r * h * a + l * s * c, this.z = r * s * c + l * h * a, this.w = r * s * a - l * h * c) : "ZYX" === n ? (this.x = l * s * a - r * h * c, this.y = r * h * a + l * s * c, this.z = r * s * c - l * h * a, this.w = r * s * a + l * h * c) : "YZX" === n ? (this.x = l * s * a + r * h * c, this.y = r * h * a + l * s * c, this.z = r * s * c - l * h * a, this.w = r * s * a - l * h * c) : "XZY" === n && (this.x = l * s * a - r * h * c, this.y = r * h * a - l * s * c, this.z = r * s * c + l * h * a, this.w = r * s * a + l * h * c), this
                        }, n.prototype.clone = function () {
                            return new n(this.x, this.y, this.z, this.w)
                        }, n.prototype.slerp = function (t, e, i) {
                            i = i || new n;
                            var r, s, a, l, h, c = this.x, p = this.y, u = this.z, d = this.w, y = t.x, f = t.y,
                                v = t.z, m = t.w;
                            return (s = c * y + p * f + u * v + d * m) < 0 && (s = -s, y = -y, f = -f, v = -v, m = -m), 1 - s > 1e-6 ? (r = Math.acos(s), a = o.sin(r), l = o.sin((1 - e) * r) / a, h = o.sin(e * r) / a) : (l = 1 - e, h = e), i.x = l * c + h * y, i.y = l * p + h * f, i.z = l * u + h * v, i.w = l * d + h * m, i
                        }, n.prototype.integrate = function (t, e, i, o) {
                            o = o || new n;
                            var r = t.x * i.x, s = t.y * i.y, a = t.z * i.z, l = this.x, h = this.y, c = this.z,
                                p = this.w, u = .5 * e;
                            return o.x += u * (r * p + s * c - a * h), o.y += u * (s * p + a * l - r * c), o.z += u * (a * p + r * h - s * l), o.w += u * (-r * l - s * h - a * c), o
                        }
                    }, {"./CMath": 27, "./Vec3": 32}],
                    31: [function (t, e) {
                    ...
                    32: [function (t, e) {
                        ...
                        o.ZERO = new o(0, 0, 0), o.UNIT_X = new o(1, 0, 0), o.UNIT_Y = new o(0, 1, 0), o.UNIT_Z = new o(0, 0, 1), o.prototype.cross = function (t, e) {
                            ...
                            return (e = e || new o).x = a * r - l * n, e.y = l * i - s * r, e.z = s * n - a * i, e
                    ...
                    33: [function (t, e) {
                        ...
                        h.prototype = new i, h.prototype.constructor = h, h.COLLIDE_EVENT_NAME = "collide", h.DYNAMIC = 1, h.STATIC = 2, h.KINEMATIC = 4, h.AWAKE = 0, h.SLEEPY = 1, h.SLEEPING = 2, h.idCounter = 0, h.wakeupEvent = {type: "wakeup"}, h.prototype.wakeUp = function () {
                            ...
                            if (this.allowSleep) {
                                var e = this.sleepState, i = this.velocity.norm2() + this.angularVelocity.norm2(),
                                    o = Math.pow(this.sleepSpeedLimit, 2);
                                e === h.AWAKE && i < o ? (this.sleepState = h.SLEEPY, this.timeLastSleepy = t, this.dispatchEvent(h.sleepyEvent)) : e === h.SLEEPY && i > o ? this.wakeUp() : e === h.SLEEPY && t - this.timeLastSleepy > this.sleepTimeLimit && (this.sleep(), this.dispatchEvent(h.sleepEvent))
                            }
                        ...
                        h.prototype.addShape = function (t, e, i) {
                            var n = new o, s = new r;
                            return e && n.copy(e), i && s.copy(i), this.shapes.push(t), this.shapeOffsets.push(n), this.shapeOrientations.push(s), this.aabbNeedsUpdate = !0, this.updateMassProperties(), this.updateBoundingRadius(), this.updateHasTrigger(), l.idToShapeMap[t.id] = t, t.body = this, this
                        ...
                        h.prototype.computeAABB = function () {
                            for (var t = this.shapes, e = this.shapeOffsets, i = this.shapeOrientations, o = t.length, n = c, r = p, s = this.quaternion, a = this.aabb, l = u, h = 0; h !== o; h++) {
                                var d = t[h];
                                s.vmult(e[h], n), n.vadd(this.position, n), i[h].mult(s, r), d.calculateWorldAABB(n, r, l.lowerBound, l.upperBound), 0 === h ? a.copy(l) : a.extend(l)
                            }
                            this.aabbNeedsUpdate = !1
                        };
                        var d = new n, y = new n;
                        new n, h.prototype.updateInertiaWorld = function (t) {
                        ...
                        h.prototype.updateMassProperties = function () {
                            ...
                            this.computeAABB(), t.set((this.aabb.upperBound.x - this.aabb.lowerBound.x) / 2, (this.aabb.upperBound.y - this.aabb.lowerBound.y) / 2, (this.aabb.upperBound.z - this.aabb.lowerBound.z) / 2), a.calculateInertia(t, this.mass, e), this.invInertia.set(e.x > 0 && !i ? 1 / e.x : 0, e.y > 0 && !i ? 1 / e.y : 0, e.z > 0 && !i ? 1 / e.z : 0), this.updateInertiaWorld(!0)
                            ...
                            if (this.previousPosition.copy(this.position), this.previousQuaternion.copy(this.quaternion), (this.type === h.DYNAMIC || this.type === h.KINEMATIC) && this.sleepState !== h.SLEEPING) {
                                var o = this.velocity, n = this.angularVelocity, r = this.position, s = this.force,
                                    a = this.torque, l = this.quaternion, c = this.invMass, p = this.invInertiaWorld,
                                    u = this.linearFactor, d = c * t;
                                o.x += s.x * d * u.x, o.y += s.y * d * u.y, o.z += s.z * d * u.z;
                    ...
                    34: [function (t, e) {
                        t("./Body");
                        var i = t("../math/Vec3"), o = t("../math/Quaternion"),
                            n = (t("../collision/RaycastResult"), t("../collision/Ray")), r = t("../objects/WheelInfo");
                        ...
                        e.exports = s, new i, new i, new i;
                        var a = new i, l = new i, h = new i;
                        new n, s.prototype.addWheel = function (t) {
                            ...
                            var s = new i;
                            for (this.getVehicleAxisWorld(this.indexForwardAxis, s), s.dot(n.velocity) < 0 && (this.currentVehicleSpeedKmHour *= -1), r = 0; r < o; r++) this.castRay(e[r]);
                            ...
                            for (r = 0; r < o; r++) {
                                ...
                                if (d.isInContact) {
                                    ...
                                    d.raycastResult.hitNormalWorld.scale(f, c), p.vsub(c, p);
                                    var v = p.dot(u);
                            ...
                            for (var t = this.chassisBody.mass, e = this.wheelInfos, i = e.length, o = 0; o < i; o++) {
                                ...
                                if (n.isInContact) {
                                    ...
                                    r -= (a < 0 ? n.dampingCompression : n.dampingRelaxation) * a, n.suspensionForce = r * t, n.suspensionForce < 0 && (n.suspensionForce = 0)
                        ...
                        s.prototype.castRay = function (t) {
                            ...
                            if (t.raycastResult.groundObject = 0, u) {
                                ...
                                if (v >= -.1) t.suspensionRelativeVelocity = 0, t.clippedInvContactDotSuspension = 10; else {
                                    var b = -1 / v;
                                    t.suspensionRelativeVelocity = g * b, t.clippedInvContactDotSuspension = b
                                }
                            ...
                            this.updateWheelTransformWorld(r), r.directionLocal.scale(-1, e), i.copy(r.axleLocal), e.cross(i, n), n.normalize(), i.normalize();
                        ...
                        s.prototype.updateFriction = function (t) {
                            for (var e = d, o = this.wheelInfos, n = o.length, r = this.chassisBody, s = f, a = y, l = 0; l < n; l++) v = (M = o[l]).raycastResult.body, M.sideImpulse = 0, M.forwardImpulse = 0, s[l] || (s[l] = new i), a[l] || (a[l] = new i);
                            for (l = 0; l < n; l++) if (v = (M = o[l]).raycastResult.body) {
                                var h = a[l];
                                this.getWheelTransformWorld(l).vectorToWorldFrame(u[this.indexRightAxis], h);
                                var c = M.raycastResult.hitNormalWorld, p = h.dot(c);
                                c.scale(p, e), h.vsub(e, h), h.normalize(), c.cross(h, s[l]), s[l].normalize(), M.sideImpulse = A(r, M.raycastResult.hitPointWorld, v, M.raycastResult.hitPointWorld, h), M.sideImpulse *= 1
                            }
                            for (this.sliding = !1, l = 0; l < n; l++) {
                                ...
                                if (M.forwardImpulse = 0, M.skidInfo = 1, v) {
                                    ...
                                    M.sliding = !1, E > _ && (this.sliding = !0, M.sliding = !0, w = x / Math.sqrt(E), M.skidInfo *= w)
                                }
                            }
                            if (this.sliding) for (l = 0; l < n; l++) 0 !== (M = o[l]).sideImpulse && M.skidInfo < 1 && (M.forwardImpulse *= M.skidInfo, M.sideImpulse *= M.skidInfo);
                            for (l = 0; l < n; l++) {
                                var M = o[l], C = new i;
                                if (M.raycastResult.hitPointWorld.vsub(r.position, C), 0 !== M.forwardImpulse) {
                                    var z = new i;
                                    s[l].scale(M.forwardImpulse, z), r.applyImpulse(z, C)
                                }
                                if (0 !== M.sideImpulse) {
                                    ...
                                    var R = new i;
                                    a[l].scale(M.sideImpulse, R), r.vectorToLocalFrame(C, C), C["xyz"[this.indexUpAxis]] *= M.rollInfluence, r.vectorToWorldFrame(C, C), r.applyImpulse(R, C), R.scale(-1, R), v.applyImpulse(R, F)
                                }
                            }
                        };
                        ...
                        function b(t, e, i, o, n) {
                            ...
                            return t.getVelocityAtWorldPoint(s, a), e.getVelocityAtWorldPoint(s, l), a.vsub(l, h), n < (r = -o.dot(h) * (1 / (S(t, i, o) + S(e, i, o)))) && (r = n), r < -n && (r = -n), r
                        }
                        ...
                        function A(t, e, i, o, n) {
                            ...
                            var r = E, s = M, a = C;
                            return t.getVelocityAtWorldPoint(e, r), i.getVelocityAtWorldPoint(o, s), r.vsub(s, a), -.2 * n.dot(a) * (1 / (t.invMass + i.invMass))
                        }
                    }, {
                        "../collision/Ray": 10,
                        "../collision/RaycastResult": 11,
                    ...
                    35: [function (t, e) {
                        var i = t("./Body"), o = t("../shapes/Sphere"), n = t("../shapes/Box"), r = t("../math/Vec3"),
                            s = t("../constraints/HingeConstraint"), a = t("../math/CMath");
                        ...
                        e.exports = l, l.prototype.addWheel = function (t) {
                            var e = (t = t || {}).body;
                            e || (e = new i(1, new o(1.2))), this.wheelBodies.push(e), this.wheelForces.push(0), new r;
                            var n = void 0 !== t.position ? t.position.clone() : new r, a = new r;
                            this.chassisBody.pointToWorldFrame(n, a), e.position.set(a.x, a.y, a.z);
                    ...
                    36: [function (t, e) {
                        ...
                        o.prototype.getNeighbors = function (t, e) {
                            for (var i = this.particles.length, o = t.id, r = this.smoothingRadius * this.smoothingRadius, s = n, a = 0; a !== i; a++) {
                                ...
                                l.position.vsub(t.position, s), o !== l.id && s.norm2() < r && e.push(l)
                            }
                        };
                        ...
                        o.prototype.update = function () {
                            for (var t = this.particles.length, e = r, i = this.speedOfSound, o = this.eps, n = 0; n !== t; n++) {
                                ...
                                (S = this.neighbors[n]).length = 0, this.getNeighbors(p, S), S.push(this.particles[n]);
                            ...
                            for (n = 0; n !== t; n++) {
                                ...
                                for (m.set(0, 0, 0), g.set(0, 0, 0), u = (S = this.neighbors[n]).length, y = 0; y !== u; y++) {
                                    var M = S[y];
                                    E.position.vsub(M.position, w);
                                    var C = w.norm();
                                    _ = -M.mass * (this.pressures[n] / (this.densities[n] * this.densities[n] + o) + this.pressures[y] / (this.densities[y] * this.densities[y] + o)), this.gradw(w, b), b.mult(_, b), m.vadd(b, m), M.velocity.vsub(E.velocity, x), x.mult(1 / (1e-4 + this.densities[n] * this.densities[y]) * this.viscosity * M.mass, x), B = this.nablaw(C), x.mult(B, x), g.vadd(x, g)
                                }
                    ...
                    37: [function (t, e) {
                        ...
                        var n = new i, r = new i, s = new i, a = new i, l = new i, h = new i, c = new i, p = new i,
                            u = new i, d = new i, y = new i;
                        o.prototype.applyForce = function () {
                            var t = this.stiffness, e = this.damping, i = this.restLength, o = this.bodyA,
                                f = this.bodyB, v = n, m = r, g = s, b = a, w = y, x = l, _ = h, B = c, S = p, E = u,
                                M = d;
                            this.getWorldAnchorA(x), this.getWorldAnchorB(_), x.vsub(o.position, B), _.vsub(f.position, S), _.vsub(x, v);
                            var C = v.norm();
                            m.copy(v), m.normalize(), f.velocity.vsub(o.velocity, g), f.angularVelocity.cross(S, w), g.vadd(w, g), o.angularVelocity.cross(B, w), g.vsub(w, g), m.mult(-t * (C - i) - e * g.dot(m), b), o.force.vsub(b, o.force), f.force.vadd(b, f.force), B.cross(b, E), S.cross(b, M), o.torque.vsub(E, o.torque), f.torque.vadd(M, f.torque)
                        }
                    }, {"../math/Vec3": 32}],
                    38: [function (t, e) {
                        var i = t("../math/Vec3"), o = t("../math/Transform"), n = t("../collision/RaycastResult"),
                            r = t("../utils/Utils");
                        ...
                        e.exports = s;
                        var a = new i, l = new i;
                        a = new i, s.prototype.updateWheel = function (t) {
                            ...
                            if (this.isInContact) {
                                ...
                                if (i >= -.1) this.suspensionRelativeVelocity = 0, this.clippedInvContactDotSuspension = 10; else {
                                    var n = -1 / i;
                    ...
                    39: [function (t, e) {
                        ...
                        r.prototype = new i, r.prototype.constructor = r, r.prototype.updateConvexPolyhedronRepresentation = function () {
                            var t = this.halfExtents.x, e = this.halfExtents.y, i = this.halfExtents.z, r = o,
                                s = [new r(-t, -e, -i), new r(t, -e, -i), new r(t, e, -i), new r(-t, e, -i), new r(-t, -e, i), new r(t, -e, i), new r(t, e, i), new r(-t, e, i)],
                                a = (new r(0, 0, 1), new r(0, 1, 0), new r(1, 0, 0), new n(s, [[3, 2, 1, 0], [4, 5, 6, 7], [5, 4, 0, 1], [2, 3, 7, 6], [0, 4, 7, 3], [1, 2, 6, 5]]));
                            ...
                            var o = t;
                            o.isZero() ? (i.x = 2 / 12 * e, i.y = 2 / 12 * e, i.z = 2 / 12 * e) : (i.x = 1 / 12 * e * (4 * o.y * o.y + 4 * o.z * o.z), i.y = 1 / 12 * e * (4 * o.x * o.x + 4 * o.z * o.z), i.z = 1 / 12 * e * (4 * o.y * o.y + 4 * o.x * o.x))
                        }, r.prototype.getSideNormals = function (t, e) {
                            var i = t, o = this.halfExtents;
                            if (i[0].set(o.x, 0, 0), i[1].set(0, o.y, 0), i[2].set(0, 0, o.z), i[3].set(-o.x, 0, 0), i[4].set(0, -o.y, 0), i[5].set(0, 0, -o.z), void 0 !== e) for (var n = 0; n !== i.length; n++) e.vmult(i[n], i[n]);
                            return i
                        ...
                        var s = new o;
                        new o, r.prototype.forEachWorldCorner = function (t, e, i) {
                            for (var o = this.halfExtents, n = [[o.x, o.y, o.z], [-o.x, o.y, o.z], [-o.x, -o.y, o.z], [-o.x, -o.y, -o.z], [o.x, -o.y, -o.z], [o.x, o.y, -o.z], [-o.x, o.y, -o.z], [o.x, -o.y, o.z]], r = 0; r < n.length; r++) s.set(n[r][0], n[r][1], n[r][2]), e.vmult(s, s), t.vadd(s, s), i(s.x, s.y, s.z)
                        };
                        ...
                        r.prototype.calculateWorldAABB = function (t, e, i, o) {
                            ...
                            a[0].set(n.x, n.y, n.z), a[1].set(-n.x, n.y, n.z), a[2].set(-n.x, -n.y, n.z), a[3].set(-n.x, -n.y, -n.z), a[4].set(n.x, -n.y, -n.z), a[5].set(n.x, n.y, -n.z), a[6].set(-n.x, n.y, -n.z), a[7].set(n.x, -n.y, n.z);
                            var r = a[0];
                            e.vmult(r, r), t.vadd(r, r), o.copy(r), i.copy(r);
                            for (var s = 1; s < 8; s++) {
                                r = a[s], e.vmult(r, r), t.vadd(r, r);
                                var l = r.x, h = r.y, c = r.z;
                                l > o.x && (o.x = l), h > o.y && (o.y = h), c > o.z && (o.z = c), l < i.x && (i.x = l), h < i.y && (i.y = h), c < i.z && (i.z = c)
                            }
                        }
                    }, {"../math/Vec3": 32, "./ConvexPolyhedron": 40, "./Shape": 45}],
                    40: [function (t, e) {
                        e.exports = r;
                        ...
                        r.prototype.computeEdges = function () {
                            ...
                            for (var o = s, n = 0; n !== t.length; n++) for (var r = t[n], a = r.length, l = 0; l !== a; l++) {
                                ...
                                for (var c = !1, p = 0; p !== i.length; p++) if (i[p].almostEquals(o) || i[p].almostEquals(o)) {
                                    c = !0;
                                    break
                                }
                                c || i.push(o.clone())
                            ...
                            for (var t = 0; t < this.faces.length; t++) {
                                ...
                                if (i.dot(n) < 0) for (console.error(".faceNormals[" + t + "] = Vec3(" + i.toString() + ") looks like it points into the shape? The vertices follow. Make sure they are ordered CCW around the normal, using the right hand rule."), e = 0; e < this.faces[t].length; e++) console.warn(".vertices[" + this.faces[t][e] + "] = Vec3(" + this.vertices[this.faces[t][e]].toString() + ")")
                            }
                        };
                        var a = new o, l = new o;
                        r.computeNormal = function (t, e, i, o) {
                            ...
                            var i = this.faces[t], o = this.vertices[i[0]], n = this.vertices[i[1]],
                                s = this.vertices[i[2]];
                        ...
                        r.prototype.clipAgainstHull = function (t, e, i, n, r, s, a, l, c) {
                            for (var p = h, u = -1, d = -Number.MAX_VALUE, y = 0; y < i.faces.length; y++) {
                                p.copy(i.faceNormals[y]), r.vmult(p, p);
                                var f = p.dot(s);
                                f > d && (d = f, u = y)
                            }
                            for (var v = [], m = i.faces[u], g = m.length, b = 0; b < g; b++) {
                                var w = i.vertices[m[b]], x = new o;
                                x.copy(w), r.vmult(x, x), n.vadd(x, x), v.push(x)
                            }
                            u >= 0 && this.clipFaceAgainstHull(s, t, e, v, a, l, c)
                        };
                        var c = new o, p = new o, u = new o, d = new o, y = new o, f = new o;
                        r.prototype.findSeparatingAxis = function (t, e, i, o, n, r, s, a) {
                            var l = c, h = p, v = u, m = d, g = y, b = f, w = Number.MAX_VALUE;
                            ...
                            if (t.uniqueAxes) for (_ = 0; _ !== t.uniqueAxes.length; _++) {
                                if (n.vmult(t.uniqueAxes[_], h), !1 === (E = this.testSepAxis(h, t, e, i, o, n))) return !1;
                                E < w && (w = E, r.copy(h))
                            } else {
                                var S = a ? a.length : t.faces.length;
                                for (_ = 0; _ < S; _++) {
                                    var E;
                                    if (B = a ? a[_] : _, h.copy(t.faceNormals[B]), n.vmult(h, h), !1 === (E = this.testSepAxis(h, t, e, i, o, n))) return !1;
                                    E < w && (w = E, r.copy(h))
                                }
                            }
                            for (var M = 0; M !== this.uniqueEdges.length; M++) {
                                i.vmult(this.uniqueEdges[M], m);
                                for (var C = 0; C !== t.uniqueEdges.length; C++) if (n.vmult(t.uniqueEdges[C], g), m.cross(g, b), !b.almostZero()) {
                                    b.normalize();
                        ...
                        r.prototype.testSepAxis = function (t, e, i, o, n, s) {
                            r.project(this, t, i, o, v), r.project(e, t, n, s, m);
                        ...
                        r.prototype.calculateLocalInertia = function (t, e) {
                            ...
                            e.x = 1 / 12 * t * (4 * o * o + 4 * n * n), e.y = 1 / 12 * t * (4 * i * i + 4 * n * n), e.z = 1 / 12 * t * (4 * o * o + 4 * i * i)
                        ...
                        r.prototype.clipFaceAgainstHull = function (t, e, i, o, n, r, s) {
                            for (var a = w, l = x, h = _, c = B, p = S, u = E, d = M, y = C, f = o, v = [], m = -1, g = Number.MAX_VALUE, b = 0; b < this.faces.length; b++) {
                                a.copy(this.faceNormals[b]), i.vmult(a, a);
                                var A = a.dot(t);
                                A < g && (g = A, m = b)
                            }
                            if (!(m < 0)) {
                                ...
                                for (var T = z.length, P = 0; P < T; P++) {
                                    var q = this.vertices[z[P]], O = this.vertices[z[(P + 1) % T]];
                                    q.vsub(O, l), h.copy(l), i.vmult(h, h), e.vadd(h, h), c.copy(this.faceNormals[m]), i.vmult(c, c), e.vadd(c, c), h.cross(c, p), p.negate(p), u.copy(q), i.vmult(u, u), e.vadd(u, u), u.dot(p);
                                    var I = z.connectedFaces[P];
                                    d.copy(this.faceNormals[I]);
                                    var V = this.getPlaneConstantOfFace(I);
                                    y.copy(d), i.vmult(y, y);
                                    var j = V - y.dot(e);
                                    for (this.clipFaceAgainstPlane(f, v, y, j); f.length;) f.shift();
                                    for (; v.length;) f.push(v.shift())
                                }
                                for (d.copy(this.faceNormals[m]), V = this.getPlaneConstantOfFace(m), y.copy(d), i.vmult(y, y), j = V - y.dot(e), F = 0; F < f.length; F++) {
                                    var k = y.dot(f[F]) + j;
                                    if (k <= n && (k = n), k <= r) {
                                        var N = f[F];
                                        if (k <= 0) {
                                            var L = {point: N, normal: y, depth: k};
                                            s.push(L)
                                        }
                                    }
                                }
                            ...
                            r = i.dot(l) + n;
                            for (var c = 0; c < a; c++) {
                                if (h = t[c], s = i.dot(h) + n, r < 0) if (s < 0) (p = new o).copy(h), e.push(p); else {
                                    var p = new o;
                                    l.lerp(h, r / (r - s), p), e.push(p)
                                } else s < 0 && (p = new o, l.lerp(h, r / (r - s), p), e.push(p), e.push(h));
                                l = h, r = s
                            }
                            return e
                            ...
                            for (var n = this.vertices, r = this.worldVertices, s = 0; s !== i; s++) e.vmult(n[s], r[s]), t.vadd(r[s], r[s]);
                        ...
                        r.prototype.calculateWorldAABB = function (t, e, i, o) {
                            for (var n, r, s, a, l, h, c = this.vertices.length, p = this.vertices, u = 0; u < c; u++) {
                                A.copy(p[u]), e.vmult(A, A), t.vadd(A, A);
                                var d = A;
                            ...
                            if (e) {
                                ...
                                for (n = 0; n < this.faceNormals.length; n++) r = this.faceNormals[n], e.vmult(r, r)
                            }
                            if (t) for (n = 0; n < i; n++) (r = o[n]).vadd(t, r)
                        };
                        var z = new o, F = new o, R = new o;
                        r.prototype.pointIsInside = function (t) {
                            var e = this.vertices.length, i = this.vertices, o = this.faces, n = this.faceNormals,
                                r = this.faces.length, s = z;
                        ...
                        r.project = function (t, e, i, o, r) {
                            var s = t.vertices.length, a = T, l = 0, h = 0, c = P, p = t.vertices;
                            c.setZero(), n.vectorToLocalFrame(i, o, e, a), n.pointToLocalFrame(i, o, c, c);
                            var u = c.dot(a);
                            h = l = p[0].dot(a);
                            for (var d = 1; d < s; d++) {
                                var y = p[d].dot(a);
                    ...
                    }, {"../math/Quaternion": 30, "../math/Transform": 31, "../math/Vec3": 32, "./Shape": 45}],
                    41: [function (t, e) {
                        e.exports = r, t("./Shape");
                        var i = t("../math/Vec3"), o = (t("../math/Quaternion"), t("./ConvexPolyhedron")),
                            n = t("../math/CMath");

                        function r(t, e, r, s, a) {
                            if (a) {
                                for (var l = s, h = n.cos, c = n.sin, p = r / 2, u = [], d = [], y = [0], f = [1], v = [], m = 2 * Math.PI / l, g = 0; g < l; g++) u.push(new i(t * h(m * g), p, t * c(m * g))), u.push(new i(t * h(m * g), -p, t * c(m * g))), g < l - 1 ? (d.push([2 * g + 2, 2 * g + 3, 2 * g + 1, 2 * g]), y.push(2 * g + 2), f.push(2 * g + 3)) : d.push([0, 1, 2 * g + 1, 2 * g]), (l % 2 == 1 || g < l / 2) && v.push(new i(h(m * (g + .5)), 0, c(m * (g + .5))));
                                d.push(f);
                                var b = [];
                                for (g = 0; g < y.length; g++) b.push(y[y.length - g - 1]);
                                return d.push(b), v.push(new i(0, 1, 0)), void o.call(this, u, d, v)
                            }
                            l = s;
                            var w = [], x = (v = [], []), _ = [], B = [];
                            for (h = n.cos, c = n.sin, w.push(new i(e * h(0), e * c(0), .5 * -r)), _.push(0), w.push(new i(t * h(0), t * c(0), .5 * r)), B.push(1), g = 0; g < l; g++) {
                                m = 2 * Math.PI / l * (g + 1);
                                var S = 2 * Math.PI / l * (g + .5);
                                g < l - 1 ? (w.push(new i(e * h(m), e * c(m), .5 * -r)), _.push(2 * g + 2), w.push(new i(t * h(m), t * c(m), .5 * r)), B.push(2 * g + 3), x.push([2 * g + 2, 2 * g + 3, 2 * g + 1, 2 * g])) : x.push([0, 1, 2 * g + 1, 2 * g]), (l % 2 == 1 || g < l / 2) && v.push(new i(h(S), c(S), 0))
                            }
                            for (x.push(B), v.push(new i(0, 0, 1)), b = [], g = 0; g < _.length; g++) b.push(_[_.length - g - 1]);
                            x.push(b), o.call(this, w, x, v)
                        }
                    ...
                    42: [function (t, e) {
                        var i = t("./Shape"), o = t("./ConvexPolyhedron"), n = t("../math/Vec3"),
                            r = t("../utils/Utils");
                        ...
                        s.prototype.getNormalAt = function (t, e, i, o) {
                            ...
                            var o = this.data, n = h, r = c, s = p, u = a;
                            ...
                            if (this.cacheEnabled) {
                                ...
                                r = new o, s = new n, this.pillarConvex = r, this.pillarOffset = s
                            }
                            ...
                            i ? (s.set((t + .75) * l, (e + .75) * l, u), p[0].set(.25 * l, .25 * l, a[t + 1][e + 1] - u), p[1].set(-.75 * l, .25 * l, a[t][e + 1] - u), p[2].set(.25 * l, -.75 * l, a[t + 1][e] - u), p[3].set(.25 * l, .25 * l, -u - 1), p[4].set(-.75 * l, .25 * l, -u - 1), p[5].set(.25 * l, -.75 * l, -u - 1), h[0][0] = 0, h[0][1] = 1, h[0][2] = 2, h[1][0] = 5, h[1][1] = 4, h[1][2] = 3, h[2][0] = 2, h[2][1] = 5, h[2][2] = 3, h[2][3] = 0, h[3][0] = 3, h[3][1] = 4, h[3][2] = 1, h[3][3] = 0, h[4][0] = 1, h[4][1] = 4, h[4][2] = 5, h[4][3] = 2) : (s.set((t + .25) * l, (e + .25) * l, u), p[0].set(-.25 * l, -.25 * l, a[t][e] - u), p[1].set(.75 * l, -.25 * l, a[t + 1][e] - u), p[2].set(-.25 * l, .75 * l, a[t][e + 1] - u), p[3].set(-.25 * l, -.25 * l, -u - 1), p[4].set(.75 * l, -.25 * l, -u - 1), p[5].set(-.25 * l, .75 * l, -u - 1), h[0][0] = 0, h[0][1] = 1, h[0][2] = 2, h[1][0] = 5, h[1][1] = 4, h[1][2] = 3, h[2][0] = 0, h[2][1] = 2, h[2][2] = 5, h[2][3] = 3, h[3][0] = 1, h[3][1] = 0, h[3][2] = 3, h[3][3] = 4, h[4][0] = 4, h[4][1] = 5, h[4][2] = 2, h[4][3] = 1), r.computeNormals(), r.computeEdges(), r.updateBoundingSphereRadius(), this.setCachedConvexTrianglePillar(t, e, i, r, s)
                    ...
                    }, {"../math/Vec3": 32, "../utils/Utils": 55, "./ConvexPolyhedron": 40, "./Shape": 45}],
                    43: [function (t, e) {
                        e.exports = n;
                        var i = t("./Shape"), o = t("../math/Vec3");
                    ...
                    44: [function (t, e) {
                        ...
                        n.prototype.calculateWorldAABB = function (t, e, i, o) {
                            ...
                            i.set(-n, -n, -n), o.set(n, n, n), 1 === r.x && (o.x = t.x), 1 === r.y && (o.y = t.y), 1 === r.z && (o.z = t.z), -1 === r.x && (i.x = t.x), -1 === r.y && (i.y = t.y), -1 === r.z && (i.z = t.z)
                        }, n.prototype.updateBoundingSphereRadius = function () {
                    ...
                    46: [function (t, e) {
                        ...
                        function n(t) {
                            if (i.call(this, {type: i.types.SPHERE}), this.radius = void 0 !== t ? t : 1, this.radius < 0) throw new Error("The sphere radius cannot be negative.");
                            this.updateBoundingSphereRadius()
                        }
                    ...
                    47: [function (t, e) {
                        e.exports = l;
                        var i = t("./Shape"), o = t("../math/Vec3"),
                            n = (t("../math/Quaternion"), t("../math/Transform")), r = t("../collision/AABB"),
                            s = t("../utils/Octree"), a = t("../math/CMath");
                        ...
                        l.prototype.updateTree = function () {
                            ...
                            for (var i = new r, n = new o, s = new o, a = new o, l = [n, s, a], h = 0; h < this.indices.length / 3; h++) {
                                var c = 3 * h;
                                this._getUnscaledVertex(this.indices[c], n), this._getUnscaledVertex(this.indices[c + 1], s), this._getUnscaledVertex(this.indices[c + 2], a), i.setFromPoints(l), t.insert(i, h)
                            }
                            t.removeEmptyNodes()
                        };
                        var c = new r;
                        l.prototype.getTrianglesInAABB = function (t, e) {
                            ...
                            for (var t = {}, e = function () {
                                ...
                                this.indices[o + 2], e(), e(), e()
                            }
                            var s = Object.keys(t);
                            for (this.edges = new Int16Array(2 * s.length), i = 0; i < s.length; i++) {
                                var a = s[i].split("_");
                        ...
                        l.prototype.calculateLocalInertia = function (t, e) {
                            ...
                            var i = g.upperBound.x - g.lowerBound.x, o = g.upperBound.y - g.lowerBound.y,
                        ...
                        l.prototype.computeLocalAABB = function (t) {
                            var e = t.lowerBound, i = t.upperBound, o = this.vertices.length, n = (this.vertices, b);
                        ...
                        l.prototype.calculateWorldAABB = function (t, e, i, o) {
                            ...
                            for (var r = [], s = [], h = 0; h <= i; h++) for (var c = 0; c <= o; c++) {
                                var p = c / o * n, u = h / i * Math.PI * 2, d = (t + e * a.cos(u)) * a.cos(p),
                                    y = (t + e * a.cos(u)) * a.sin(p), f = e * a.sin(u);
                                r.push(d, y, f)
                            }
                            for (h = 1; h <= i; h++) for (c = 1; c <= o; c++) {
                                var v = (o + 1) * h + c - 1, m = (o + 1) * (h - 1) + c - 1, g = (o + 1) * (h - 1) + c,
                                    b = (o + 1) * h + c;
                                s.push(v, m, b), s.push(m, g, b)
                            }
                            return new l(r, s)
                        }
                    }, {
                    ...
                    48: [function (t, e) {
                        ...
                        var n = [], r = [], s = [];
                        o.prototype.solve = function (t, e) {
                            var i, o, a, l, h, c = 0, p = this.iterations, u = this.tolerance * this.tolerance,
                                d = this.equations, y = d.length, f = e.bodies, v = f.length, m = t;
                            if (0 !== y) for (var g = 0; g !== v; g++) f[g].updateSolveMassProperties();
                            var b = r, w = s, x = n;
                            for (b.length = y, w.length = y, x.length = y, g = 0; g !== y; g++) {
                                var _ = d[g];
                                x[g] = 0, w[g] = _.computeB(m), b[g] = 1 / _.computeC()
                            }
                            if (0 !== y) {
                                for (g = 0; g !== v; g++) {
                                ...
                                for (c = 0; c !== p; c++) {
                                    l = 0;
                                    for (var E = 0; E !== y; E++) _ = d[E], i = w[E], o = b[E], (h = x[E]) + (a = o * (i - _.computeGWlambda() - _.eps * h)) < _.minForce ? a = _.minForce - h : h + a > _.maxForce && (a = _.maxForce - h), x[E] += a, l += a > 0 ? a : -a, _.addToWlambda(a);
                                    if (l * l < u) break
                                }
                                for (g = 0; g !== v; g++) {
                                    var M, C = (M = f[g]).velocity, A = M.angularVelocity;
                                    M.vlambda.vmul(M.linearFactor, M.vlambda), C.vadd(M.vlambda, C), M.wlambda.vmul(M.angularFactor, M.wlambda), A.vadd(M.wlambda, A)
                                }
                                for (var z = d.length, F = 1 / m; z--;) d[z].multiplier = x[z] * F
                            }
                            return c
                        }
                    }, {"../math/Quaternion": 30, "../math/Vec3": 32, "./Solver": 49}],
                    49: [function (t, e) {
                        function i() {
                            this.equations = []
                        }
                    ...
                    50: [function (t, e) {
                        ...
                        function p(t, e, i, o) {
                            for (c.push(t), t.visited = !0, e(t, i, o); c.length;) for (var n, r = c.pop(); n = h(r.children);) n.visited = !0, e(n, i, o), c.push(n)
                        }
                        ...
                        n.prototype.createNode = function () {
                            ...
                            for (var g = 0; g !== c; g++) {
                                ...
                                x.children.push(_), x.eqs.push(b), _.children.push(x), _.eqs.push(b)
                            }
                            var B, S = 0, E = s;
                            f.tolerance = this.tolerance, f.iterations = this.iterations;
                            for (var M = a; B = h(i);) {
                                E.length = 0, M.bodies.length = 0, p(B, u, M.bodies, E);
                                var C = E.length;
                                for (E = E.sort(d), v = 0; v !== C; v++) f.addEquation(E[v]);
                                f.solve(t, M), f.removeAllEquations(), S++
                            }
                            return S
                        }
                    }, {"../math/Quaternion": 30, "../math/Vec3": 32, "../objects/Body": 33, "./Solver": 49}],
                    51: [function (t, e) {
                        var i = function () {
                        };
                        e.exports = i, i.prototype = {
                            constructor: i, addEventListener: function (t, e) {
                    ...
                    54: [function (t, e) {
                        ...
                        e.exports = i, i.prototype.get = function (t, e) {
                            ...
                            return n >= 0 && (this.data.keys.splice(n, 1), delete this.data[o], !0)
                        }, i.prototype.reset = function () {
                            this.data = {keys: []}
                    ...
                    }, {"../math/Vec3": 32, "./Pool": 53}],
                    57: [function (t, e) {
                        e.exports = u;
                        var i = t("../collision/AABB"), o = t("../objects/Body"), n = t("../shapes/Shape"),
                            r = t("../collision/Ray"), s = t("../math/Vec3"), a = t("../math/Transform"),
                            l = (t("../shapes/ConvexPolyhedron"), t("../math/Quaternion")),
                            h = (t("../solver/Solver"), t("../utils/Vec3Pool")), c = t("../equations/ContactEquation"),
                        ...
                        u.prototype.createContactEquation = function (t, e, i, o, n, r) {
                            var s;
                            this.contactPointPool.length ? ((s = this.contactPointPool.pop()).bi = t, s.bj = e) : s = new c(t, e), s.enabled = t.collisionResponse && e.collisionResponse && i.collisionResponse && o.collisionResponse;
                            ...
                            var i = t.bi, o = t.bj, n = t.si, r = t.sj, s = this.world, a = this.currentContactMaterial,
                                l = a.friction, h = n.material || i.material, c = r.material || o.material;
                            if (h && c && h.friction >= 0 && c.friction >= 0 && (l = h.friction * c.friction), l > 0) {
                                var u = l * s.gravity.length(), d = i.invMass + o.invMass;
                                d > 0 && (d = 1 / d);
                                var y = this.frictionEquationPool, f = y.length ? y.pop() : new p(i, o, u * d),
                        ...
                        u.prototype.createFrictionFromAverage = function (t) {
                            ...
                            if (this.createFrictionEquationsFromContact(e, this.frictionResult) && 1 !== t) {
                                ...
                                d.setZero(), y.setZero(), f.setZero();
                                for (var n = e.bi, r = (e.bj, 0); r !== t; r++) (e = this.result[this.result.length - 1 - r]).bodyA !== n ? (d.vadd(e.ni, d), y.vadd(e.ri, y), f.vadd(e.rj, f)) : (d.vsub(e.ni, d), y.vadd(e.rj, y), f.vadd(e.ri, f));
                                var s = 1 / t;
                                y.scale(s, i.ri), f.scale(s, i.rj), o.ri.copy(i.ri), o.rj.copy(i.rj), d.normalize(), d.tangents(i.t, o.t)
                            }
                        };
                        var v = new s, m = new s, g = new l, b = new l;
                        u.prototype.getContacts = function (t, e, i, n, r, s, a) {
                            this.contactPointPool = r, this.frictionEquationPool = a, this.result = n, this.frictionResult = s;
                            for (var l = g, h = b, c = v, p = m, u = 0, d = t.length; u !== d; u++) {
                                ...
                                for (var x = 0 == y.collisionResponse || 0 == f.collisionResponse || y.type & o.KINEMATIC && f.type & o.STATIC || y.type & o.STATIC && f.type & o.KINEMATIC || y.type & o.KINEMATIC && f.type & o.KINEMATIC, _ = 0; _ < y.shapes.length; _++) {
                                    ...
                                    for (var B = y.shapes[_], S = 0; S < f.shapes.length; S++) {
                                        f.quaternion.mult(f.shapeOrientations[S], h), f.quaternion.vmult(f.shapeOffsets[S], p), p.vadd(f.position, p);
                                        var E = f.shapes[S];
                                        if (B.collisionFilterMask & E.collisionFilterGroup && E.collisionFilterMask & B.collisionFilterGroup && !(c.distanceTo(p) > B.boundingSphereRadius + E.boundingSphereRadius)) {
                                            ...
                                            var M = null;
                                            B.material && E.material && (M = i.getContactMaterial(B.material, E.material) || null), this.currentContactMaterial = M || w || i.defaultContactMaterial;
                                            var C = this[B.type | E.type];
                                            if (C && (B.type < E.type ? C.call(this, B, E, c, p, l, h, y, f, B, E, x) : C.call(this, E, B, p, c, h, l, f, y, B, E, x)) && x) {
                                                i.shapeOverlapKeeper.set(B.id, E.id), i.bodyOverlapKeeper.set(y.id, f.id);
                                                var A = {si: B, sj: E};
                                                i.triggerDic.set(B.id, E.id, A), i.oldTriggerDic.set(B.id, E.id, A)
                                            }
                                        }
                                    }
                                }
                            ...
                            o.vsub(i, p.ni), p.ni.normalize(), p.ri.copy(p.ni), p.rj.copy(p.ni), p.ri.mult(t.radius, p.ri), p.rj.mult(-e.radius, p.rj), p.ri.vadd(i, p.ri), p.ri.vsub(s.position, p.ri), p.rj.vadd(o, p.rj), p.rj.vsub(a.position, p.rj), this.result.push(p), this.createFrictionEquationsFromContact(p, this.frictionResult)
                        };
                        ...
                        u.prototype[n.types.PLANE | n.types.TRIMESH] = u.prototype.planeTrimesh = function (t, e, i, o, n, r, l, h, c, p, u) {
                            ...
                            for (var f = 0; f < e.vertices.length / 3; f++) {
                                e.getVertex(f, d);
                                var v = new s;
                                v.copy(d), a.pointToWorldFrame(o, r, v, d);
                                var m = x;
                                if (d.vsub(i, m), y.dot(m) <= 0) {
                                    ...
                                    g.ni.copy(y);
                                    var b = _;
                                    y.scale(m.dot(y), b), d.vsub(b, b), g.ri.copy(b), g.ri.vsub(l.position, g.ri), g.rj.copy(d), g.rj.vsub(h.position, g.rj), this.result.push(g), this.createFrictionEquationsFromContact(g, this.frictionResult)
                                }
                            }
                        };
                        var B = new s, S = new s, E = (new s, new s), M = new s, C = new s, A = new s, z = new s,
                            F = new s, R = new s, T = new s, P = new s, q = new s, O = new s, I = new i, V = [];
                        u.prototype[n.types.SPHERE | n.types.TRIMESH] = u.prototype.sphereTrimesh = function (t, e, i, o, n, s, l, h, c, p, u) {
                            var d = C, y = A, f = z, v = F, m = R, g = T, b = I, w = M, x = S, _ = V;
                            a.pointToLocalFrame(o, s, i, m);
                            var j = t.radius;
                            b.lowerBound.set(m.x - j, m.y - j, m.z - j), b.upperBound.set(m.x + j, m.y + j, m.z + j), e.getTrianglesInAABB(b, _);
                            for (var k = E, N = t.radius * t.radius, L = 0; L < _.length; L++) for (var W = 0; W < 3; W++) if (e.getVertex(e.indices[3 * _[L] + W], k), k.vsub(m, x), x.norm2() <= N) {
                                if (w.copy(k), a.pointToWorldFrame(o, s, w, k), k.vsub(i, x), u) return !0;
                                (G = this.createContactEquation(l, h, t, e, c, p)).ni.copy(x), G.ni.normalize(), G.ri.copy(G.ni), G.ri.scale(t.radius, G.ri), G.ri.vadd(i, G.ri), G.ri.vsub(l.position, G.ri), G.rj.copy(k), G.rj.vsub(h.position, G.rj), this.result.push(G), this.createFrictionEquationsFromContact(G, this.frictionResult)
                            }
                            for (L = 0; L < _.length; L++) for (W = 0; W < 3; W++) {
                                ...
                                m.vsub(d, g);
                                var U = g.dot(f);
                                if (U > 0 && D < 0 && (m.vsub(d, g), v.copy(f), v.normalize(), U = g.dot(v), v.scale(U, g), g.vadd(d, g), (Z = g.distanceTo(m)) < t.radius)) {
                                    if (u) return !0;
                                    var G = this.createContactEquation(l, h, t, e, c, p);
                                    g.vsub(m, G.ni), G.ni.normalize(), G.ni.scale(t.radius, G.ri), a.pointToWorldFrame(o, s, g, g), g.vsub(h.position, G.rj), a.vectorToWorldFrame(s, G.ni, G.ni), a.vectorToWorldFrame(s, G.ri, G.ri), this.result.push(G), this.createFrictionEquationsFromContact(G, this.frictionResult)
                                }
                            }
                            for (var H = P, K = q, Q = O, X = B, Y = (L = 0, _.length); L !== Y; L++) {
                                e.getTriangleVertices(_[L], H, K, Q), e.getNormal(_[L], X), m.vsub(H, g);
                                var Z = g.dot(X);
                                if (X.scale(Z, g), m.vsub(g, g), Z = g.distanceTo(m), r.pointInTriangle(g, H, K, Q) && Z < t.radius) {
                                    if (u) return !0;
                                    G = this.createContactEquation(l, h, t, e, c, p), g.vsub(m, G.ni), G.ni.normalize(), G.ni.scale(t.radius, G.ri), a.pointToWorldFrame(o, s, g, g), g.vsub(h.position, G.rj), a.vectorToWorldFrame(s, G.ni, G.ni), a.vectorToWorldFrame(s, G.ri, G.ri), this.result.push(G), this.createFrictionEquationsFromContact(G, this.frictionResult)
                                }
                            }
                            _.length = 0
                        };
                        ...
                        u.prototype[n.types.SPHERE | n.types.PLANE] = u.prototype.spherePlane = function (t, e, i, o, n, r, s, a, l, h, c) {
                            if (N.set(0, 0, 1), r.vmult(N, N), N.negate(N), N.normalize(), N.mult(t.radius, L), i.vsub(o, j), N.mult(N.dot(j), k), j.vsub(k, W), -j.dot(N) <= t.radius) {
                                if (c) return !0;
                                var p = this.createContactEquation(s, a, t, e, l, h);
                                p.ni.copy(N), p.ri.copy(L), p.rj.copy(W);
                                var u = p.ri, d = p.rj;
                                u.vadd(i, u), u.vsub(s.position, u), d.vadd(o, d), d.vsub(a.position, d), this.result.push(p), this.createFrictionEquationsFromContact(p, this.frictionResult)
                            }
                            return !1
                        };
                        ...
                        var K = new s, Q = new s, X = new s, Y = new s, Z = [new s, new s, new s, new s, new s, new s],
                            J = new s, $ = new s, tt = new s, et = new s;
                        u.prototype[n.types.SPHERE | n.types.BOX] = u.prototype.sphereBox = function (t, e, i, o, n, r, s, a, l, h, c) {
                            var p = this.v3pool, u = Z;
                            i.vsub(o, K), e.getSideNormals(u, r);
                            for (var d = t.radius, y = !1, f = $, v = tt, m = et, g = null, b = 0, w = 0, x = 0, _ = null, B = 0, S = u.length; B !== S && !1 === y; B++) {
                                ...
                                if (C < M + d && C > 0) {
                                    var A = X, z = Y;
                                    A.copy(u[(B + 1) % 3]), z.copy(u[(B + 2) % 3]);
                                    var F = A.norm(), R = z.norm();
                                    A.normalize(), z.normalize();
                                    var T = K.dot(A), P = K.dot(z);
                                    if (T < F && T > -F && P < R && P > -R) {
                                        var q = Math.abs(C - M - d);
                                        if ((null === _ || q < _) && (_ = q, w = T, x = P, g = M, f.copy(E), v.copy(A), m.copy(z), b++, c)) return !0
                                    }
                                }
                            }
                            if (b) {
                                ...
                                f.mult(-d, O.ri), O.ni.copy(f), O.ni.negate(O.ni), f.mult(g, f), v.mult(w, v), f.vadd(v, f), m.mult(x, m), f.vadd(m, O.rj), O.ri.vadd(i, O.ri), O.ri.vsub(s.position, O.ri), O.rj.vadd(o, O.rj), O.rj.vsub(a.position, O.rj), this.result.push(O), this.createFrictionEquationsFromContact(O, this.frictionResult)
                            }
                            for (var I = p.get(), V = J, j = 0; 2 !== j && !y; j++) for (var k = 0; 2 !== k && !y; k++) for (var N = 0; 2 !== N && !y; N++) if (I.set(0, 0, 0), j ? I.vadd(u[0], I) : I.vsub(u[0], I), k ? I.vadd(u[1], I) : I.vsub(u[1], I), N ? I.vadd(u[2], I) : I.vsub(u[2], I), o.vadd(I, V), V.vsub(i, V), V.norm2() < d * d) {
                                if (c) return !0;
                                y = !0, (O = this.createContactEquation(s, a, t, e, l, h)).ri.copy(V), O.ri.normalize(), O.ni.copy(O.ri), O.ri.mult(d, O.ri), O.rj.copy(I), O.ri.vadd(i, O.ri), O.ri.vsub(s.position, O.ri), O.rj.vadd(o, O.rj), O.rj.vsub(a.position, O.rj), this.result.push(O), this.createFrictionEquationsFromContact(O, this.frictionResult)
                            }
                            p.release(I), I = null;
                            var L = p.get(), W = p.get(), D = (O = p.get(), p.get()), U = (q = p.get(), u.length);
                            for (j = 0; j !== U && !y; j++) for (k = 0; k !== U && !y; k++) if (j % 3 != k % 3) {
                                u[k].cross(u[j], L), L.normalize(), u[j].vadd(u[k], W), O.copy(i), O.vsub(W, O), O.vsub(o, O);
                                var G = O.dot(L);
                                for (L.mult(G, D), N = 0; N === j % 3 || N === k % 3;) N++;
                        ...
                        var it = new s, ot = new s, nt = new s, rt = new s, st = new s, at = new s, lt = new s,
                            ht = new s, ct = new s, pt = new s;
                        u.prototype[n.types.SPHERE | n.types.CONVEXPOLYHEDRON] = u.prototype.sphereConvex = function (t, e, i, o, n, r, s, a, l, h, c) {
                            ...
                            for (var w = !1, x = (v = 0, d.length); v !== x && !1 === w; v++) {
                                ...
                                M.vsub(E, C);
                                var A = C.dot(S), z = pt;
                                if (i.vsub(E, z), A < 0 && z.dot(S) > 0) {
                                    for (var F = [], R = 0, T = B.length; R !== T; R++) {
                                        var P = p.get();
                                        r.vmult(y[B[R]], P), o.vadd(P, P), F.push(P)
                                    }
                                    if (H(F, S, i)) {
                                        if (c) return !0;
                                        w = !0;
                                        ...
                                        S.mult(-A, O);
                                        var I = p.get();
                                        S.mult(-f, I), i.vsub(o, q.rj), q.rj.vadd(I, q.rj), q.rj.vadd(O, q.rj), q.rj.vadd(o, q.rj), q.rj.vsub(a.position, q.rj), q.ri.vadd(i, q.ri), q.ri.vsub(s.position, q.ri), p.release(O), p.release(I), this.result.push(q), this.createFrictionEquationsFromContact(q, this.frictionResult), R = 0;
                                        for (var V = F.length; R !== V; R++) p.release(F[R]);
                                        return
                                    }
                                    for (R = 0; R !== B.length; R++) {
                                        var j = p.get(), k = p.get();
                                        r.vmult(y[B[(R + 1) % B.length]], j), r.vmult(y[B[(R + 2) % B.length]], k), o.vadd(j, j), o.vadd(k, k);
                                        var N = ot;
                                        k.vsub(j, N);
                                        var L = nt;
                                        N.unit(L);
                                        ...
                                        if (W.vsub(i, G), U > 0 && U * U < N.norm2() && G.norm2() < f * f) {
                                            ...
                                            return p.release(j), p.release(k), p.release(W), p.release(G), void p.release(D)
                                        }
                                        p.release(j), p.release(k), p.release(W), p.release(G), p.release(D)
                                    }
                                    for (R = 0, V = F.length; R !== V; R++) p.release(F[R])
                                }
                            }
                        ...
                        u.prototype[n.types.PLANE | n.types.CONVEXPOLYHEDRON] = u.prototype.planeConvex = function (t, e, i, o, n, r, s, a, l, h, c) {
                            ...
                            for (var d = 0, y = yt, f = 0; f !== e.vertices.length; f++) if (p.copy(e.vertices[f]), r.vmult(p, p), o.vadd(p, p), p.vsub(i, y), u.dot(y) <= 0) {
                                if (c) return !0;
                                var v = this.createContactEquation(s, a, t, e, l, h), m = ft;
                                u.mult(u.dot(y), m), p.vsub(m, m), m.vsub(i, v.ri), v.ni.copy(u), p.vsub(o, v.rj), v.ri.vadd(i, v.ri), v.ri.vsub(s.position, v.ri), v.rj.vadd(o, v.rj), v.rj.vsub(a.position, v.rj), this.result.push(v), d++, this.enableFrictionReduction || this.createFrictionEquationsFromContact(v, this.frictionResult)
                            }
                        ...
                        u.prototype[n.types.CONVEXPOLYHEDRON] = u.prototype.convexConvex = function (t, e, i, o, n, r, s, a, l, h, c, p, u) {
                            ...
                            if (!(i.distanceTo(o) > t.boundingSphereRadius + e.boundingSphereRadius) && t.findSeparatingAxis(e, i, n, o, r, d, p, u)) {
                                ...
                                for (var v = 0, m = 0; m !== y.length; m++) {
                                    ...
                                    d.negate(g.ni), y[m].normal.negate(f), f.mult(y[m].depth, f), y[m].point.vadd(f, b), w.copy(y[m].point), b.vsub(i, b), w.vsub(o, w), b.vadd(i, b), b.vsub(s.position, b), w.vadd(o, w), w.vsub(a.position, w), this.result.push(g), v++, this.enableFrictionReduction || this.createFrictionEquationsFromContact(g, this.frictionResult)
                                }
                        ...
                        u.prototype[n.types.PLANE | n.types.PARTICLE] = u.prototype.planeParticle = function (t, e, i, o, n, r, s, a, l, h, c) {
                            var p = gt;
                            p.set(0, 0, 1), s.quaternion.vmult(p, p);
                            var u = bt;
                            if (o.vsub(s.position, u), p.dot(u) <= 0) {
                                if (c) return !0;
                                var d = this.createContactEquation(a, s, e, t, l, h);
                                d.ni.copy(p), d.ni.negate(d.ni), d.ri.set(0, 0, 0);
                                var y = wt;
                                p.mult(p.dot(o), y), o.vsub(y, y), d.rj.copy(y), this.result.push(d), this.createFrictionEquationsFromContact(d, this.frictionResult)
                            }
                        };
                        var xt = new s;
                        u.prototype[n.types.PARTICLE | n.types.SPHERE] = u.prototype.sphereParticle = function (t, e, i, o, n, r, s, a, l, h, c) {
                            ...
                            if (p.set(0, 0, 1), o.vsub(i, p), p.norm2() <= t.radius * t.radius) {
                                ...
                                p.normalize(), u.rj.copy(p), u.rj.mult(t.radius, u.rj), u.ni.copy(p), u.ni.negate(u.ni), u.ri.set(0, 0, 0), this.result.push(u), this.createFrictionEquationsFromContact(u, this.frictionResult)
                            }
                        };
                        ...
                        u.prototype[n.types.PARTICLE | n.types.CONVEXPOLYHEDRON] = u.prototype.convexParticle = function (t, e, i, o, n, r, s, a, l, h, c) {
                            ...
                            if (f.copy(o), f.vsub(i, f), n.conjugate(_t), _t.vmult(f, f), t.pointIsInside(f)) {
                                ...
                                if (-1 !== p) {
                                    ...
                                    u.mult(y, d), d.vadd(o, d), d.vsub(i, d), x.rj.copy(d), u.negate(x.ni), x.ri.set(0, 0, 0);
                                    var _ = x.ri, B = x.rj;
                        ...
                        u.prototype[n.types.CONVEXPOLYHEDRON | n.types.HEIGHTFIELD] = u.prototype.convexHeightfield = function (t, e, i, o, n, r, s, l, h, c, p) {
                            ...
                            var g = Math.floor((m.x - y) / d) - 1, b = Math.ceil((m.x + y) / d) + 1,
                                w = Math.floor((m.y - y) / d) - 1, x = Math.ceil((m.y + y) / d) + 1;
                            if (!(b < 0 || x < 0 || g > u.length || w > u[0].length)) {
                                g < 0 && (g = 0), b < 0 && (b = 0), w < 0 && (w = 0), x < 0 && (x = 0), g >= u.length && (g = u.length - 1), b >= u.length && (b = u.length - 1), x >= u[0].length && (x = u[0].length - 1), w >= u[0].length && (w = u[0].length - 1);
                                var _ = [];
                                e.getRectMinMax(g, w, b, x, _);
                                var B = _[0], S = _[1];
                                if (!(m.z - y > S || m.z + y < B)) for (var E = g; E < b; E++) for (var M = w; M < x; M++) {
                                    var C = !1;
                                    if (e.getConvexTrianglePillar(E, M, !1), a.pointToWorldFrame(o, r, e.pillarOffset, f), i.distanceTo(f) < e.pillarConvex.boundingSphereRadius + t.boundingSphereRadius && (C = this.convexConvex(t, e.pillarConvex, i, f, n, r, s, l, h, c, p, v, null)), p && C) return !0;
                                    if (e.getConvexTrianglePillar(E, M, !0), a.pointToWorldFrame(o, r, e.pillarOffset, f), i.distanceTo(f) < e.pillarConvex.boundingSphereRadius + t.boundingSphereRadius && (C = this.convexConvex(t, e.pillarConvex, i, f, n, r, s, l, h, c, p, v, null)), p && C) return !0
                                }
                            }
                        };
                        ...
                        u.prototype[n.types.SPHERE | n.types.HEIGHTFIELD] = u.prototype.sphereHeightfield = function (t, e, i, o, n, r, s, l, h, c, p) {
                            var u = e.data, d = t.radius, y = e.elementSize, f = Rt, v = Ft;
                            a.pointToLocalFrame(o, r, i, v);
                            var m = Math.floor((v.x - d) / y) - 1, g = Math.ceil((v.x + d) / y) + 1,
                                b = Math.floor((v.y - d) / y) - 1, w = Math.ceil((v.y + d) / y) + 1;
                            if (!(g < 0 || w < 0 || m > u.length || b > u[0].length)) {
                                m < 0 && (m = 0), g < 0 && (g = 0), b < 0 && (b = 0), w < 0 && (w = 0), m >= u.length && (m = u.length - 1), g >= u.length && (g = u.length - 1), w >= u[0].length && (w = u[0].length - 1), b >= u[0].length && (b = u[0].length - 1);
                                var x = [];
                                e.getRectMinMax(m, b, g, w, x);
                                var _ = x[0], B = x[1];
                                if (!(v.z - d > B || v.z + d < _)) for (var S = this.result, E = m; E < g; E++) for (var M = b; M < w; M++) {
                                    var C = S.length, A = !1;
                                    if (e.getConvexTrianglePillar(E, M, !1), a.pointToWorldFrame(o, r, e.pillarOffset, f), i.distanceTo(f) < e.pillarConvex.boundingSphereRadius + t.boundingSphereRadius && (A = this.sphereConvex(t, e.pillarConvex, i, f, n, r, s, l, t, e, p)), p && A) return !0;
                                    if (e.getConvexTrianglePillar(E, M, !0), a.pointToWorldFrame(o, r, e.pillarOffset, f), i.distanceTo(f) < e.pillarConvex.boundingSphereRadius + t.boundingSphereRadius && (A = this.sphereConvex(t, e.pillarConvex, i, f, n, r, s, l, t, e, p)), p && A) return !0;
                    ...
                    58: [function (t, e) {
                        e.exports = g, t("../shapes/Shape");
                        var i = t("../math/Vec3"), o = t("../math/Quaternion"), n = t("../solver/GSSolver"),
                            r = (t("../equations/ContactEquation"), t("../equations/FrictionEquation"), t("./Narrowphase")),
                            s = t("../utils/EventTarget"), a = t("../collision/ArrayCollisionMatrix"),
                            l = t("../collision/ObjectCollisionMatrix"), h = t("../collision/OverlapKeeper"),
                            c = t("../material/Material"), p = t("../material/ContactMaterial"),
                            u = t("../objects/Body"), d = t("../utils/TupleDictionary"),
                            y = t("../collision/RaycastResult"), f = t("../collision/AABB"), v = t("../collision/Ray"),
                        ...
                        function g(t) {
                            t = t || {}, s.apply(this), this.dt = -1, this.allowSleep = !!t.allowSleep, this.contacts = [], this.frictionEquations = [], this.quatNormalizeSkip = void 0 !== t.quatNormalizeSkip ? t.quatNormalizeSkip : 0, this.quatNormalizeFast = void 0 !== t.quatNormalizeFast && t.quatNormalizeFast, this.time = 0, this.timeFixed = 0, this.stepnumber = 0, this.default_dt = 1 / 60, this.nextId = 0, this.gravity = new i, t.gravity && this.gravity.copy(t.gravity), this.broadphase = void 0 !== t.broadphase ? t.broadphase : new m, this.bodies = [], this.solver = void 0 !== t.solver ? t.solver : new n, this.constraints = [], this.narrowphase = new r(this), this.collisionMatrix = new a, this.collisionMatrixPrevious = new a, this.bodyOverlapKeeper = new h, this.shapeOverlapKeeper = new h, this.materials = [], this.contactmaterials = [], this.contactMaterialTable = new d, this.defaultMaterial = new c("default"), this.defaultContactMaterial = new p(this.defaultMaterial, this.defaultMaterial, {
                                ...
                                type: "removeBody",
                                body: null
                            }, this.idToBodyMap = {}, this.broadphase.setWorld(this), this.substeps = 0, this.cm = new l, this.tm = new l, this.triggerDic = new d, this.oldTriggerDic = new d, this.contactsDic = new d, this.oldContactsDic = new d
                        }

                        g.idToBodyMap = {}, g.idToShapeMap = {}, g.prototype = new s, new f;
                        var b = new v;
                        if (g.prototype.getContactMaterial = function (t, e) {
                            ...
                            return i.mode = v.ALL, i.from = t, i.to = e, i.callback = o, b.intersectWorld(this, i)
                        }, g.prototype.raycastAny = function (t, e, i, o) {
                            return i.mode = v.ANY, i.from = t, i.to = e, i.result = o, b.intersectWorld(this, i)
                        }, g.prototype.raycastClosest = function (t, e, i, o) {
                            return i.mode = v.CLOSEST, i.from = t, i.to = e, i.result = o, b.intersectWorld(this, i)
                        }, g.prototype.remove = function (t) {
                            g.SLEEPING = !1, t.world = null;
                            ...
                            var w = Date.now();
                            performance.timing && performance.timing.navigationStart && (w = performance.timing.navigationStart), performance.now = function () {
                                return Date.now() - w
                            }
                        }
                        ...
                        var x, _, B, S, E, M, C = {type: "postStep"}, A = {type: "preStep"},
                            z = {type: "collide", body: null, contact: null}, F = [], R = [], T = [], P = [];
                        new i, new i, new i, new i, new i, new i, new i, new i, new i, new o, new o, new o, new i, g.prototype.internalStep = function (t) {
                            this.dt = t;
                            var e, i = this.contacts, o = T, n = P, r = this.numObjects(), s = this.bodies,
                                a = this.solver, l = this.gravity, h = this.doProfiling, c = this.profile,
                                p = u.DYNAMIC, d = this.constraints, y = R, f = (l.norm(), l.x), v = l.y, m = l.z,
                                b = 0;
                            for (h && (e = performance.now()), b = 0; b !== r; b++) if ((V = s[b]).useGravity && V.type === p) {
                                var w = V.force, x = V.mass;
                                w.x += x * f, w.y += x * v, w.z += x * m
                            }
                            b = 0;
                            for (var _ = this.subsystems.length; b !== _; b++) this.subsystems[b].update();
                            h && (e = performance.now()), o.length = 0, n.length = 0, this.broadphase.collisionPairs(this, o, n), h && (c.broadphase = performance.now() - e);
                            var B = d.length;
                            for (b = 0; b !== B; b++) if (!(L = d[b]).collideConnected) for (var S = o.length - 1; S >= 0; S -= 1) (L.bodyA === o[S] && L.bodyB === n[S] || L.bodyB === o[S] && L.bodyA === n[S]) && (o.splice(S, 1), n.splice(S, 1));
                            ...
                            if (this.frictionEquations.length = 0, this.narrowphase.getContacts(o, n, this, i, E, this.frictionEquations, y), 0 != i.length || !g.SLEEPING) {
                                ...
                                a.solve(t, this), h && (c.solve = performance.now() - e), a.removeAllEquations();
                                var U = Math.pow;
                                for (b = 0; b !== r; b++) if ((V = s[b]).type & p) {
                                ...
                                for (this.dispatchEvent(A), b = 0; b !== r; b++) (V = s[b]).preStep && V.preStep.call(V);
                                h && (e = performance.now());
                                var X = this.stepnumber % (this.quatNormalizeSkip + 1) == 0, Y = this.quatNormalizeFast;
                                for (b = 0; b !== r; b++) s[b].integrate(t, X, Y);
                                for (this.clearForces(), this.broadphase.dirty = !0, h && (c.integrate = performance.now() - e), this.time += t, this.timeFixed += t, this.stepnumber += 1, this.dispatchEvent(C), b = 0; b !== r; b++) {
                                    var Z = (V = s[b]).postStep;
                                    Z && Z.call(V)
                                }
                                if (this.allowSleep) {
                                    for (b = 0; b !== r; b++) s[b].sleepTick(this.time);
                                    for (g.SLEEPING = !0, b = 0; b !== r; b++) if ((V = s[b]).type != u.STATIC && !V.isSleeping()) {
                                        g.SLEEPING = !1;
                                        break
                                    }
                                } else g.SLEEPING = !1
                            ...
                            bodyA: null,
                            bodyB: null
                        }, S = {type: "endContact", bodyA: null, bodyB: null}, E = {
                            ...
                            if ((t || e) && this.bodyOverlapKeeper.getDiff(x, _), t) {
                                for (var i = 0, o = x.length; i < o; i += 2) B.bodyA = this.getBodyById(x[i]), B.bodyB = this.getBodyById(x[i + 1]), this.dispatchEvent(B);
                                B.bodyA = B.bodyB = null
                            }
                            if (e) {
                                for (i = 0, o = _.length; i < o; i += 2) S.bodyA = this.getBodyById(_[i]), S.bodyB = this.getBodyById(_[i + 1]), this.dispatchEvent(S);
                                S.bodyA = S.bodyB = null
                            }
                            x.length = _.length = 0;
                            var n = this.hasAnyEventListener("beginShapeContact"),
                                r = this.hasAnyEventListener("endShapeContact");
                            if ((n || r) && this.shapeOverlapKeeper.getDiff(x, _), n) {
                            ...
                            if (r) {
                                for (i = 0, o = _.length; i < o; i += 2) s = this.getShapeById(_[i]), a = this.getShapeById(_[i + 1]), M.shapeA = s, M.shapeB = a, M.bodyA = s.body, M.bodyB = a.body, this.dispatchEvent(M);
                        ...
                        g.prototype.emitTriggeredEvents = function () {
                            if (0 != this.substeps) {
                                for (var t, e, i = this.triggerDic.getLength(); i--;) if (t = this.triggerDic.getKeyByIndex(i), null != (e = this.triggerDic.getDataByKey(t))) {
                                    var o = e.si, n = e.sj;
                                    this.tm.get(o, n) ? q.event = "onTriggerStay" : (this.tm.set(o, n, !0), q.event = "onTriggerEnter"), q.selfShape = o, q.otherShape = n, q.selfBody = o.body, q.otherBody = n.body, o.dispatchEvent(q), q.selfShape = n, q.otherShape = o, q.selfBody = n.body, q.otherBody = o.body, n.dispatchEvent(q)
                                }
                                for (i = this.oldTriggerDic.getLength(); i > 0;) i--, t = this.oldTriggerDic.getKeyByIndex(i), null == this.triggerDic.getDataByKey(t) && null != (e = this.oldTriggerDic.getDataByKey(t)) && (o = e.si, n = e.sj, this.tm.set(o, n, !1), this.oldTriggerDic.del(o.id, n.id) && i--, q.event = "onTriggerExit", q.selfShape = o, q.otherShape = n, q.selfBody = o.body, q.otherBody = n.body, o.dispatchEvent(q), q.selfShape = n, q.otherShape = o, q.selfBody = n.body, q.otherBody = o.body, n.dispatchEvent(q));
                            ...
                            if (0 != this.substeps) {
                                ...
                                for (o = this.contactsDic.getLength(); o--;) if (t = this.contactsDic.getKeyByIndex(o), null != (e = this.contactsDic.getDataByKey(t))) {
                                    n = e[0].si, r = e[0].sj;
                                    var a = n.body, l = r.body;
                                    this.cm.get(a, l) ? O.event = "onCollisionStay" : (this.cm.set(a, l, !0), O.event = "onCollisionEnter"), O.bi = a, O.contact = e[0], O.contacts = e, O.body = l, O.selfShape = n, O.otherShape = r, a.dispatchEvent(O), O.body = a, O.selfShape = r, O.otherShape = n, l.dispatchEvent(O)
                                }
                                var h = I;
                                for (o = h.length; o--;) {
                                    var c;
                                    n = (c = h[o]).si, r = c.sj, null == this.oldContactsDic.get(n.id, r.id) && this.oldContactsDic.set(n.id, r.id, c)
                                }
                                for (o = this.oldContactsDic.getLength(); o--;) t = this.oldContactsDic.getKeyByIndex(o), null == this.contactsDic.getDataByKey(t) && (n = (e = this.oldContactsDic.getDataByKey(t)).si, r = e.sj, a = n.body, l = r.body, this.cm.get(a, l) && (a.isSleeping() && l.isSleeping() || (this.cm.set(a, l, !1), O.bi = a, O.contact = e, O.event = "onCollisionExit", O.body = l, O.selfShape = n, O.otherShape = r, O.contacts.length = 0, O.contacts.push(e), a.dispatchEvent(O), O.body = a, O.selfShape = r, O.otherShape = n, l.dispatchEvent(O))));
                                this.contactsDic.reset(), this.oldContactsDic.reset(), F = I, I = this.contacts.slice(), this.contacts.length = 0
                            }
                        }
                    }, {
                        "../collision/AABB": 3,
